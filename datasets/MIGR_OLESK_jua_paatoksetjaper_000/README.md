# MIGR_OLESK Oleskelulupatiedot - Päätökset ja peruutukset

- **Identifier:** `MIGR_OLESK_jua_paatoksetjaper_000.xml`
...
| `NEW_DECISION_REASON_NAME_FIN` | Uuden ratkaisun syy | — | — | — |
| `VALIDITY_PERMANENT` | Pysyva lupa | — | — | — |
| `PAATOS_PERUTTU` | Päätös peruttu | — | — | — |
| `CANCELLATION_DATE` | Peruutuksen pvm | — | — | — |
| `DCSN_TYPE_ID` | Päätöstyyppi | — | — | — |
| `DCSN_LEVEL` | Paatostaso | — | — | — |
| `DCSN_GROUNDS_NAME_FIN` | Paatosperuste | — | — | — |
...
| `Rank_paatos_uusin` | Uusin päätös | — | — | — |
| `Edell_paatoksen_loppupvm` | Edellisen päätöksen loppumispäivämäärä | — | — | — |
...
Päivämäärä jolloin päätös on kirjattu järjestelmään. Hakemuksissa ja päätöksissä käytetty tilastopäivämäärä.

#### `NEW_DECISION_REASON_NAME_FIN` — Uuden ratkaisun syy

Jos asiassa useita päätöksiä, kertoo syyn uudelle päätökselle. Esimerkiksi kirjoistusvirheen korjaus tai muutoksenhaku. Periaatteessa esim. jos samalla päätöstasolla on enemmän kuin yksi päätös, tulisi tässä ottaa kantaa mikä oon uuden päätöksen syy. Käytännössä tätä ei kuitenkaan aina merkitä.
...
Saa arvon 1 jos päätös on peruttu.

Peruutetuissa luvissa on alipeittoa, koska rekisterimerkintöjen perusteella ei aina pysty päättelemään mikä lupa on peruttu.

#### `CANCELLATION_DATE` — Peruutuksen pvm

Päivämäärä, jolloin Migri on tehnyt luvan peruuttamisen. Tämä ei ole sama asia kuin asian lainvoimaisuus. Asiasta on voitu valittaa ja on mahdollista, että valitustuomioistuin on myöhemmin kumonnut Migrin päätöksen.

#### `DCSN_TYPE_ID` — Päätöstyyppi

1 = "Myönteinen"
2 = "Harkinta-ajan antaminen" 
3 = "Asia rauennut" 
4 = "Lakkautettu"
5 = "Peruutetaan"
6 = "Tutkimatta jättäminen" 	
7 = "Kielteinen KV, myönteinen OLE"
8 = "Vastustetaan" 
9 = "Kielteinen"

#### `DCSN_LEVEL` — Paatostaso

1 = "Ensimmäinen päätös"
2 = "Hao:n jälkeinen päätös"
3 = "Kho:n jälkeinen päätös"

Laskennallinen kenttä. Samaan asiaan voidaan tehdä useita päätöksiä. Joillakin päätöksillä korjataan aikaisemmassa päätöksessä olleita esim. nimien kirjoitusasun virheitä. Lisäksi valituksen ja hallinto-oikeuksien käsittelyjen jälkeen asiaan voidaan tehdä uusi päätös:  HaO/KHO jälkeinen päätös

#### `DCSN_GROUNDS_NAME_FIN` — Paatosperuste

Myönteisissä toistetaan hakemuksen peruste (esim Erityisasiantuntija), kielteisissä syy esimerkiksi: K: Ei vastattu selvityspyyntöön tai K: Kielteinen osapäätös
...
Jos hakemuksella on useampia päätöksiä, järjestysnumero kertoo monesko päätös kyseessä

#### `Edell_paatoksen_loppupvm` — Edellisen päätöksen loppumispäivämäärä

#### `VALIDITY_START_DATE` — Voimassaolon alkupvm

Päivämäärä jolloin luvan voimassaolo alkaa. Tyhjät arvot = 1.1.1900

#### `VALIDITY_END_DATE` — Voimassaolon loppupvm

Päivämäärä jolloin luvan voimassaolo loppuu.  Tyhjät arvot = 31.12.9999
