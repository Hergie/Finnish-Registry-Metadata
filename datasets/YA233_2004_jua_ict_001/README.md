# FIRM_ICT Tietotekniikka ja sähköinen kauppa yrityksissä 2004 (YA233)

- **Identifier:** `YA233_2004_jua_ict_001.xml`
- **DOI:** `work_2017-12_2017-12-04_ain_0004`
- **Temporal coverage:** 2004-01-01 - 2004-12-31
- **Published:** 2018-03-19
- **Organisation:** Tilastokeskus
- **Variable count:** 133
- **Observation count:** 3,176
...
| `KANTK` | kannettavia tietokoneita käytössä (1=kyllä, 0=ei) | — | — | — |
...
| `LAHIVHLO` | osuus henkilökunnasta käyttää lähiverkkoon kytk tietokonetta (%) | — | — | — |
| `KANTKHLO` | osuus henkilökunnasta käyttää kannettavaa tietokonetta (%) | — | — | — |
...
| `EDIFACT` | käytössä EDIFACT  (1=kyllä, 0=ei) | — | — | — |
| `XML` | käytössä  XML/EDI  (1=kyllä, 0=ei) | — | — | — |
| `MUUEDI` | käytössä muu EDI  (1=kyllä, 0=ei) | — | — | — |
| `EOSEDI` | Ei osaa sanoa mikä EDI käytössä | — | — | — |
...
| `TYPEFACT` | sähköisen kaupan tekniikka EDIFACT (1=kyllä, 0=ei) | — | — | — |
...
| `CPRMERK` | mahdoll ongelmien merkitys internet-kaupalle | — | — | — |
...
| `yr_yrek_liikevaihto1` | yr_yrek_liikevaihto 1 | — | — | — |
