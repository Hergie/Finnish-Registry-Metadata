# SES Harmonisoitu palkkarakennepaneeli - kuntasektori 1995-2019

- **Identifier:** `SES_19952019_jua_harkun_001.xml`
- **DOI:** `ati_2014-05_2014-05-15_ain_0001`
- **Temporal coverage:** 1995-01-01 - 2019-12-31
- **Published:** 2022-01-26
- **Organisation:** Tilastokeskus
- **Variable count:** 32
- **Observation count:** 10,746,092
...
Kuntasektorin harmonisoitu palkkarakennepaneeli vuosilta 1995-2019 tarjoaa työsuhdetason tietoa palkansaajien
(palkatuista) tunneista, palkoista ja palkanosista + yksilötason tietoa työntekijän iästä, koulutuksesta yms. + tietoa työsuhteesta vastaavan kunnan tai kuntayhteisön paikallisyksikön toimialasta jne (yhteensä 32 muuttujaa). Tilasto on kokonaisaineisto kattaen kaikki kuntien ja kuntayhtymien työ- ja virkasuhteiset palkansaajat (10746092 työsuhdehavaintoa). 

Tiedot on harmonisoitu keskenään vertailukelpoisiksi sekä suhteessa yksityisen ja valtiosektorin vastaaviin palkkatilastokäsitteisiin että yli vuosien. Siinä missä alkuperäinen palkkarakenneaineisto takaa sektorien välisen vertailtavuuden saman tilastovuoden sisällä, takaa harmonisoitu palkkarakenneaineisto lisäksi vielä sen, että käytettävät muuttujat todella mittaavat/kuvaavat samaa asiaa tilastovuodesta riippumatta. Vuosien yli harmonisoinnissa noudattavat harmonisoidut muuttujat vuoden 2019 kuntasektorin palkkarakenneaineiston yhteydessä käytettyjä muuttujien muodostussääntöjä ja luokitusmuuttujien luokitusversioita. HAR_ -etuliite muuttujan nimen alussa viittaa yli ajan harmonisoituun muuttujaan. Loput mukaan otetuista muuttujista olivat yli ajan harmonisoidussa muodossa jo vuosipoikkileikkausaineistoissa.
...
| `PYKSKUNTA` | Paikallisyksikön sijaintikunnasta | — | kunta_2_2019_01_01 | — |
...
| `HAR_TUTK1_VUODET` | Tutkinnon pituus | — | koulutus_1_2016_01_01 | — |
...
Tilaston tilastointivuosi. Tässä tiedostossa 1995-2019. Tiedot kuvaavat pääasiassa vuoden viimeistä neljännestä. Vuosittainen tilastointiajankohta on lokakuu ja tilastointijakso voi pisimmillään olla yksi kuukausi (jos ilmoitusjakso ei satu täysin lokakuulle, niin ilmoitusajankohdaksi valitaan  syys–lokakuulle osuvat viikot).

#### `AINE` — Aineistotunnus

Aineistotunnuksella erotetaan eri tiedonantajalähteet toisistaan. Kuntasektorilla mahdollisia arvoja vv. 1995-2019 vain yksi, 
...
#### `PYKSKUNTA` — Paikallisyksikön sijaintikunnasta

**Luokitus / Classification:** kunta_2_2019_01_01

Tieto toimipaikan tai paikallisyksikön sijaintikunnasta. Tieto saadaan yritysrekisteristä (YTY) tai suoraan palkka-aineistosta.

#### `PMUOTO` — Palkkausmuoto

Työsuhteen palkkausmuoto. Mahdolliset arvot vv 1995-2019: 
...
Harmonisoitu rajausehto. Arvo=1 tietueilla, jotka voidaan ottaa mukaan kokonaistyöajan kokonaistuntiansioita (HAR_TUNTIPALKKA) koskeviin tarkasteluihin. Muuten arvo=0.
...
Harmonisoitu kokonaistyöaika kuukaudessa. Säännöllisen kuukausityöajan ja lisä- ja ylityötuntien yhteissumma kuukaudessa. Lisä- ja ylityötunnit (HAR_YLIT) kuvaavat yksinomaan todellisia palkattuja työssäolotunteja. Sen sijaan säännöllisen kuukausityöajan tunnit (=HAR_TYOAIKAKK-HAR_YLIT) eivät kuvaa pelkkää  todellista työssöoloaikaa, sillä myös TES:in/VES:in määrittämälle työssäoloajalle sijoittuvat palkattomat ja palkalliset poissaolot sisältyvät käsitteeseen.
...
Harmonisoidut säännöllisesti jokaiseen palkanmaksujaksoon sisältyvät provisiot ja muut vastaavat yksilön työsuoritukseen perustuvat ansiot euroina kuukaudessa (vrt. HAR_TULOSPA vuodessa!). Kuntasektorilla kattaa vain tuntipalkkaisten työsuhteiden kappalemäärä-/suoritusperusteiset urakkapalkat. Kuntasektorilla aina, kun  PMUOTO=1 (=kuukausipalkkainen työsuhde), HAR_PROV=0.
