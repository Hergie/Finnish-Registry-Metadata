...
FOLK-henkilöaineiston työssäkäyntimoduuli sisältää tietoja, jotka liittyvät henkilöiden työsuhteisiin, työpaikkoihin, työttömyyteen ja työnhakuun. Moduulissa on myös työnantajaa koskevia tietoja vuoden viimeisen viikon työsuhteesta (TVM) sekä vuoden pisimmästä, vähintään puoli vuotta kestäneestä työsuhteesta (ATV). Moduulin tietoja on saatavilla vuodesta 1987 alkaen, ellei muuttujankuvauksessa toisin mainita. 

<b> Valmisaineiston tarkentava nimi </b> 

Työssäkäyntitilaston tietoja henkilön työpaikasta (ammatista, toimipaikoista, toimipisteistä), henkilöstä (työnhausta ja jaksotietoja maksujaksoista) ja työnantajasta (sijainnista, omistuksesta, liikevaihdosta, henkilöstömäärästä ja palkoista) (FOLK_TKT)** 

<b> Aineiston perusjoukko, koostaminen ja tietolähteet </b> 

Kohdejoukko on Suomessa vakituisesti asunut väestö vuoden viimeisenä päivänä.  

Aineisto perustuu Tilastokeskuksen henkilötietovarannon työssäkäyntitilastoihin sekä yritysrekisterin toimipaikkatietoihin.  
...
Aineisto on tarkoitettu käytettäväksi FIONA-etäpalvelun kautta, ja se on linkitettävissä muihin henkilövalmisaineistomoduuleihin suojatun henkilönumeron sekä henkilön työnantajan liittyvien suojattujen tunnusten avulla. Tietoja voi tilata tutkimuksen kohdejoukolle ja tietylle ajanjaksolle.  Aineiston kokonaisaineiston (kaikki muuttujat koko populaatiolle ja kaikilta saatavissa olevilta vuosilta) käyttöoikeus myönnetään vain, jos tutkimuksellinen tarve sitä erityisesti edellyttää. Aineistosta voi tilata muuttujia voi tilata myös räätälöidyn version, joka sisältää vain osan valmisaineiston muuttujista. 

FOLK Työssäkäynti -aineistot ovat FIONA-etäkäyttöjärjestelmässä jaettuina vuosikansioihin tilastovuosittain. 

Vimeisimmät FOLK työssäkäyntiaineistot ovat kansiossa FOLK_TKT_A, jossa tiedostot on jaettuna tilastovuosittain. Tiedostonimet ovat muodossa folk_tkt_"vuosi"_1. 
 
<b> Tarkempaa tietoa muuttujista </b> 

Yrittäjien (amas2 = 2) ATV-tietoja puuttuu vuosilta 1998 ja 2005–2010. 

Vuoden 2023 päivityksessä moduulin vuositaulun 2006 syrtun-muuttujan virheelliset arvot korjattiin takautuvasti. 
...
| `yrtun_s` | Suojattu yritystunnus (TVM) | — | — | — |
| `ykstun_s` | Suojattu toimipaikan tunnus (TVM) | — | — | — |
| `tpitunj1_s` | Suojattu jäsenyhteisö- tai virastotunnus (TVM) | — | — | — |
| `tpitunt1_s` | Suojattu kunta- ja valtiosektorin toimipistetunnus (TVM) | — | — | — |
...
| `yrtun2_s` | Suojattu yritystunnus (ATV) | — | — | — |
| `ykstun2_s` | Suojattu toimipaikkatunnus (ATV) | — | — | — |
| `tpitunj2_s` | Suojattu jäsenyhteisötunnus tai virastotunnus (ATV) | — | — | — |
| `tpitunt2_s` | Suojattu kunta- ja valtiosektorin toimipistetunnus (ATV) | — | — | — |
...
Suojattu toimipaikan tunnus (ATV) on  Yritys- ja toimipaikkarekisterin käyttämä toimipaikkatunnus, joka sisältää sekä yksityisen että julkisen sektorin toimipaikkatunnuksia. Myös yksityisellä sektorilla voi olla esim. yritysjärjestelyistä johtuen poikkeuksia, joissa toimipaikkatunnus liittyy useampaan kuin yhteen yritystunnukseen samana vuonna. 
