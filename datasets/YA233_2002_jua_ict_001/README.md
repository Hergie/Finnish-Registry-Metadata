# FIRM_ICT Tietotekniikka ja sähköinen kauppa yrityksissä 2002 (YA233)

- **Identifier:** `YA233_2002_jua_ict_001.xml`
- **DOI:** `work_2017-12_2017-12-04_ain_0006`
- **Temporal coverage:** 2002-01-01 - 2002-12-31
- **Published:** 2018-03-19
- **Organisation:** Tilastokeskus
- **Variable count:** 150
- **Observation count:** 3,091
...
| `yr_hk_suuruusluokka` | Henkilöstön suuruusluokka, yritysrekisteri | — | — | — |
...
| `KANOSU` | Kannettavien tietokoneiden osuus yrityksen tietokoneista (%) | — | — | — |
| `INTERNET` | internet yhteys (1=kyllä, 0=ei) | — | — | — |
| `INETHLO` | osuus henkilökunnasta käyt Internetiä (%) | — | — | — |
| `inetlkm` | net yhteys modeemi (analoginen) (1=kyllä, 0=ei) | — | — | — |
| `MODEM` | netyhteys modeemi (1=kyllä, 0=ei) | — | — | — |
| `ISDN` | netyhteys isdn (1=kyllä, 0=ei) | — | — | — |
| `XDSL` | netyhteys xdsl (1=kyllä, 0=ei) | — | — | — |
| `KIINLTON` | kiinteä langaton (1=kyllä, 0=ei) | — | — | — |
| `KIINMUU1` | muu laajakaista < 2 Mbps(1=kyllä, 0=ei) | — | — | — |
| `KIINMUU2` | muu laajakaista > 2Mbps (1=kyllä, 0=ei) | — | — | — |
| `LTONMUU` | muu langaton, mm. matkapuhelin (1=kyllä, 0=ei) | — | — | — |
| `YHTEOS` | Internet-yhteystyyppi Ei osaa sanoa | — | — | — |
| `SPOSTI` | sähköposti (1=kyllä, 0=ei) | — | — | — |
| `INTRA` | intranet (1=kyllä, 0=ei) | — | — | — |
| `EXTRA` | extranet (1=kyllä, 0=ei) | — | — | — |
| `NETASTI` | asiatiedon hankintaa netistä (1=kyllä, 0=ei) | — | — | — |
| `NETMARK` | markkinoiden seurantaa netissä (1=kyllä, 0=ei) | — | — | — |
| `NETMYJAL` | myynnin jälk palvelujen käyttöä netissä (1=kyllä, 0=ei) | — | — | — |
| `NETPANK` | pankkipalveluita netissä (1=kyllä, 0=ei) | — | — | — |
| `NETREKRY` | henkilöstön rekrytointia netissä (1=kyllä, 0=ei) | — | — | — |
| `NETVIROM` | asiointia viranomaisten kanssa netissä (1=kyllä, 0=ei) | — | — | — |
| `NETDIGI` | tavaroita tai palveluja netistä (1=kyllä, 0=ei) | — | — | — |
...
| `KOTTIL` | tuotteiden tilaus sähköisesti (1=kyllä, 0=ei) | — | — | — |
| `KOTDIGI` | tuotteiden toimitus sähköisesti (1=kyllä, 0=ei) | — | — | — |
| `KOTMYJAL` | kotisivuilla myynnin jälkeisiä palveluita (1=kyllä, 0=ei) | — | — | — |
| `KOTSUOJ` | suojattu yhteys kotisivuilla (1=kyllä, 0=ei) | — | — | — |
| `KOTKIELI` | informaatiota muilla kuin kotimaisilla kielillä (1=kyllä, 0=ei) | — | — | — |
| `KOTMOBIL` | kotisivut käytettävissä mobiililaitteella (1=kyllä, 0=ei) | — | — | — |
| `NETCOM` | nettimyyntiä (1=kyllä, 0=ei) | — | — | — |
| `NETCOM_XML` | NETCOM_XML | — | — | — |
| `NETPAY` | otti vastaan on-line maksuja netissä (1=kyllä, 0=ei) | — | — | — |
| `MARKPMYY` | nettimyyntiä muille yrityksille markkinapaikkojen kautta (1=kyllä, 0=ei) | — | — | — |
| `MOTKUVA` | yrityskuva (1=ei lainkaan, 2=jonkin verran, 3=suuri, 9=eos) | — | — | — |
| `MOTKUST` | kustannusten vähentäminen (1=ei lainkaan, 2=jonkin verran, 3=suuri, 9=eos) | — | — | — |
| `MOTPROS` | prosessin nopeutuminen (1=ei lainkaan, 2=jonkin verran, 3=suuri, 9=eos) | — | — | — |
| `MOTPALV` | palvelun parantuminen (1=ei lainkaan, 2=jonkin verran, 3=suuri, 9=eos) | — | — | — |
| `MOTUUSAS` | uusien asiakkaisen löytyminen (1=ei lainkaan, 2=jonkin verran, 3=suuri, 9=eos) | — | — | — |
| `MOTUUSTU` | uusien tuotteiden lanseeraus (1=ei lainkaan, 2=jonkin verran, 3=suuri, 9=eos) | — | — | — |
| `MOTKILPA` | kilpailussa pärjääminen (1=ei lainkaan, 2=jonkin verran, 3=suuri, 9=eos) | — | — | — |
| `MOTLAAJ` | pääsy laajemmille markkinoille (1=ei lainkaan, 2=jonkin verran, 3=suuri, 9=eos) | — | — | — |
| `NETOSTO` | nettiostoja (1=kyllä, 0=ei, 9=EOS) | — | — | — |
| `NETOSTO_XML` | NETOSTO_XML | — | — | — |
| `MARKPOST` | materiaalien ja palvelujen ostaminen (1=kyllä, 0=ei) | — | — | — |
| `EDI` | käytössä EDI (1=kyllä, 0=ei) | — | — | — |
| `EDIVAST` | vastaanottanut edi tilauksia (=myynti) (1=kyllä, 0=ei) | — | — | — |
| `EDITEKE` | tehnyt edi tilauksia (=ostot) (1=kyllä, 0=ei) | — | — | — |
| `EDIRAHA` | maksuliikenne edillä (1=kyllä, 0=ei) | — | — | — |
| `EDIMUU` | käyttänyt ediä muuhun tarkoitukseen (1=kyllä, 0=ei) | — | — | — |
| `ETYPE` | edi tyyppi (1=EDIFACT, 2=XML/EDI, 3=muu, 9=eos) | — | — | — |
| `ITGEREK` | edi ja asiakasrekisteri integroitu (1=kyllä, 0=ei) | — | — | — |
| `ITGIREK` | internet ja asiakasrekisteri integroitu (1=kyllä, 0=ei) | — | — | — |
| `ITGEIREK` | ei integrointia asiakasrekisteriin | — | — | — |
| `ITGEOREK` | ei osaa sanoa onko integrointia asiakasrekisteriin | — | — | — |
| `ITGETUO` | edi integroitu tavaran- ja palvelujen tuotantoon (1=kyllä, 0=ei) | — | — | — |
| `ITGITUO` | internet integroitu tavaran- ja palvelujen tuotantoon (1=kyllä, 0=ei) | — | — | — |
| `ITGEITUO` | ei integrointia tavaran- ja palvelujen tuotantoon | — | — | — |
| `ITGEOTUO` | eos onko integrointia tavaran- ja palvelujen tuotantoon | — | — | — |
| `ITGETOI` | Edi integroitu tavaran- tai palvelujen toimituksiin (1=kyllä, 0=ei) | — | — | — |
| `ITGITOI` | Internet  integroitu tavaran- tai palvelujen toimituksiin | — | — | — |
| `ITGEITOI` | tavaran tai palvelujen toimitus ei integroitu | — | — | — |
| `ITGEOTOI` | ei osaa sanoa onko tavaran tai palvelujen toimitus ei integroitu | — | — | — |
| `ITGETIL` | edi integroitu tavaran- ja palvelujen ostoihin (1=kyllä, 0=ei) | — | — | — |
| `ITGITIL` | internet integroitu tavaran- ja palvelujen ostoihin (1=kyllä, 0=ei) | — | — | — |
| `ITGEITIL` | ei integrointia tavaran- ja palvelujen ostoihin | — | — | — |
| `ITGEOTIL` | eos onko integrointia tavaran- ja palvelujen ostoihin | — | — | — |
| `ITGELAS` | edi integroitu laskutukseen ja maksujärjestelmiin (1=kyllä, 0=ei) | — | — | — |
| `ITGILAS` | internet integroitu laskutukseen ja maksujärjestelmiin (1=kyllä, 0=ei) | — | — | — |
| `ITGEILAS` | ei integrointia laskutukseen ja maksujärjestelmiin | — | — | — |
| `ITGEOLAS` | ei osaa sanoa onko integrointia laskutukseen ja maksujärjestelmiin | — | — | — |
| `CPRSOVE` | yrityksen tuotteet eivät sovellu myyntiin Internetissä (1=ei lainkaan, 2=jonkin verran, 3=suuri, 0=eos) | — | — | — |
| `CPRPOTE` | asiakaspotentiaali liian pieni  (1=ei lainkaan, 2=jonkin verran, 3=suuri, 0=eos) | — | — | — |
| `CPRVALM` | asiakkaat eivät ole valmiita Internet-kauppaan (1=ei lainkaan, 2=jonkin verran, 3=suuri, 0=eos) | — | — | — |
| `CPREPMAK` | epävarmuus maksuliikenteessä  (1=ei lainkaan, 2=jonkin verran, 3=suuri, 0=eos) | — | — | — |
| `CPREPOIK` | epävarmuus oikeudellisista kysymyksistä (kuluttajasuoja, takuut yms.) (1=ei lainkaan, 2=jonkin verran, 3=suuri, 0=eos) | — | — | — |
| `CPRLOG` | logistiikkaan liittyy ongelmia (1=ei lainkaan, 2=jonkin verran, 3=suuri, 0=eos) | — | — | — |
| `CPRKUST` | liian suuret käyttöönotto-/ylläpitokustannukset (1=ei lainkaan, 2=jonkin verran, 3=suuri, 0=eos) | — | — | — |
| `CPRPAIPI` | painopiste nykyisissä myynti- /jakelukanavissa (1=ei lainkaan, 2=jonkin verran, 3=suuri, 0=eos) | — | — | — |
| `CPRMUU` | muita ongelmia | — | — | — |
| `IPRVIRUS` | tietoturvaongelmat/virusvaara (1=ei lainkaan, 2=jonkin verran, 3 suuri, 0=eos) | — | — | — |
| `IPRTEKN` | teknisesti monimutkaista (1=ei lainkaan, 2=jonkin verran, 3 suuri, 0=eos) | — | — | — |
| `IPRTEKKUS` | tekniikan ja ohjelmien kustannukset (1=ei lainkaan, 2=jonkin verran, 3 suuri, 0=eos) | — | — | — |
| `IPRKOTKUS` | kotisivujen kehittämis- ja ylläpitokustannukset (1=ei lainkaan, 2=jonkin verran, 3 suuri, 0=eos) | — | — | — |
| `IPRTLIKUS` | suuret tietoliikennekulut (1=ei lainkaan, 2=jonkin verran, 3 suuri, 0=eos) | — | — | — |
| `IPRAIKA` | menetetty työaika (1=ei lainkaan, 2=jonkin verran, 3 suuri, 0=eos) | — | — | — |
| `IPRHIDAS` | tietoliikenteen hitaus/epävarmuus (1=ei lainkaan, 2=jonkin verran, 3 suuri, 0=eos) | — | — | — |
| `IPRHYOTY` | liian vähän hyötyä odotettavissa (1=ei lainkaan, 2=jonkin verran, 3 suuri, 0=eos) | — | — | — |
| `NETVOL` | ilmoitettu nettimyynnin arvo (euro tai mk, 1000) | — | — | — |
| `VALUUT1` | NETVOL-muuttujan valuutta | — | — | — |
| `NETVOLOS` | ilmoitettu nettimyynnin osuus liikevaihdosta (%) | — | — | — |
| `NETVOLEURO` | ilmoitettu nettimyynnin arvo (euro) | — | — | — |
| `NETVOL_XML_EURO` | — | — | — | — |
| `NETVOLOSUUDET` | NETVOLOSUUDET | — | — | — |
| `NETVOLOSUUDET_XML` | NETVOLOSUUDET_XML | — | — | — |
...
| `ASJULK` | osuus nettimyynnistä julkiselle sektorille (%) | — | — | — |
| `julkeuro` | nettimyynti julkiselle sektorille  (euro) | — | — | — |
| `ASSUOMI` | Tilaukset  Suomesta (1=kyllä, 0=ei) | — | — | — |
| `suomieuro` | nettimyynti Suomeen euroina | — | — | — |
| `ASEU` | Tilaukset  muualta EU:sta (1=kyllä, 0=ei) | — | — | — |
| `eueuro` | nettimyynti muihin EU-maihin euroina | — | — | — |
| `ASMUU` | Tilaukset  muista maista (1=kyllä, 0=ei) | — | — | — |
| `muueuro` | nettimyynti muihin maihin euroina | — | — | — |
| `OSTOVOL` | ilmoitettu nettiostojen arvo (euro tai mk, 1000) | — | — | — |
| `VALUUT2` | OSTOVOL-muuttujan valuutta | — | — | — |
| `OSTVOLOS` | nettiostojen osuus kaikista ostoista (1=mitätön arvo, 2=<1, 3=1-4, 4=5-9,5=10-24, 6=25-49, 7=50<, 8=EOS) | — | — | — |
| `OSTOVOLEURO` | OSTOVOLEURO | — | — | — |
| `OSTOVOL_XML_EURO` | — | — | — | — |
| `OSTVOLOSUUDET` | OSTVOLOSUUDET | — | — | — |
| `OSTVOLOSUUDET_XML` | — | — | — | — |
| `EMYVOL` | ilmoitettu edi-kaupan arvo (euro tai mk, 1000) | — | — | — |
| `VALUUT3` | EMYVOL-muuttujan valuutta | — | — | — |
| `EMYVOLOS` | ilmoitettu edi myynnin osuus liikevaihdosta (%) | — | — | — |
| `EMYVOLEURO` | EMYVOLEURO | — | — | — |
| `EMYVOL_XML_EURO` | EMYVOL_XML_EURO | — | — | — |
| `EMYVOLOSUUDET` | EMYVOLOSUUDET | — | — | — |
| `EMYVOLOSUUDET_XML` | EMYVOLOSUUDET_XML | — | — | — |
| `EOSVOL` | ilmoitettu edi-ostojen arvo (euro tai mk, 1000) | — | — | — |
| `VALUUT4` | EOSVOL-muuttujan valuutta | — | — | — |
| `EOSVOLOS` | ilmoitettu edi ostojen osuus kaikista ostoista (1=<1, 2=1-9, 3=10-24, 4=25-49,5=50-74, 6=75< % | — | — | — |
| `EOSVOLEURO` | EOSVOLEURO | — | — | — |
| `EOSVOL_XML_EURO` | EOSVOL_XML_EURO | — | — | — |
| `EOSVOLOSUUDET` | EOSVOLOSUUDET | — | — | — |
| `EOSVOLOSUUDET_XML` | EOSVOLOSUUDET_XML | — | — | — |
| `LVEURO` | Lopullinen tilaston liikevaihto | — | — | — |
| `OMAKULUT` | ilmoitetut tuloslaskelman kulut yht (euro tai mk, 1000) | — | — | — |
| `VALUUT6` | OMAKULUT-muuttujan valuutta | — | — | — |
| `KULUEURO` | KULUEURO | — | — | — |
| `yr_yrek_liikevaihto` | Liikevaihto, yritysrekisteri, 1000 mk | — | — | — |
