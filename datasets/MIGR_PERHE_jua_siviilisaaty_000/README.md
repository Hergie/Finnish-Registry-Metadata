# MIGR_PERHE Oleskelulupaa hakeneiden perhetiedot - siviilisääty
...
<b>MIGR_PERHE-valmisaineisto koostuu tauluista perheside ja siviilisääty. Tällä sivulla on aineistokuvaus taululle siviilisääty. </b>

<b>Siviilisääty</b>-taulussa on mukana kaikki rivit, mitä asiakkaalle on kirjattu UMAan siviilisäädystä. Tästä pitäisi pystyä päättelemään jokaisen hetken siviilisääty kaikille asiakkaille, jos tiedot ovat vain merkitty oikein UMAan. Muokkauspäivä tarkoittaa viimeisintä hetkeä, jolloin kyseistä riviä on muutettu. Tieto voi olla jokin, jota ei ole näissä kentissä. Siviilisääty tulee päätellä hieman eri tavalla kuin muista tauluista, koska avioliitto tai avioero voidaan kirjata takautuvasti, ja näyttäisi siltä, että eri kirjauksille luodaan omat rivinsä. 
...
| `DIVORCE_MONTH` | Avioeron rekisteröimiskuukausi | — | — | — |
...
Selitys koodille löytyy metatiedoista taulusta MARITAL_STATUS_CODE_TO_NAME.
...
Tietoa on muokattu tänä ajankohtana.

#### `CREATION_MONTH` — Luomiskuukausi

Tieto on luotu tänä ajankohtana.
