# FIRM_ENVPROT Teollisuuden ympäristönsuojelumenot 2014-2019

- **Identifier:** `FIRM_20142019_jua_ENVPROT_001.xml`
- **DOI:** `ympsm_2021-10_2021-10-20_ain_0001`
- **Temporal coverage:** 2014-01-01 - 2019-12-31
...
Teollisuuden ympäristönsuojelumenot -valmisaineisto kuvaa ympäristönsuojelusta teollisuudelle aiheutuvia menoja. Tutkimuskäyttöön tuleva toimipaikkatason aineisto alkaa vuodesta 2014. Tilastossa esitetään ympäristönsuojeluinvestointien sekä ympäristönsuojelusta aiheutununeiden toimintamenojen suuruudet toimialoittain ja käyttökohteittain (ympäristölohkoittain).

Tilasto on tarkoitettu yhteiskunnallisen päätöksenteon, yritysten ja niiden etujärjestöjen sekä tutkimuksen tarpeisiin. Tilasto mahdollistaa ympäristönsuojelusta aiheutuneiden menojen vertailua eri toimialojen kesken. Tilastointi noudattaa EU:n tilastoviraston, Eurostatin, muotoilemia tilastointiperiaatteita, mikä varmistaa tietojen vertailtavuuden muiden Euroopan maiden sekä kansainvälisten järjestöjen vastaaviin tilastotietoihin.

Tilasto kattaa teolliset toimialat eli kaivos- ja kaivannaistoiminnan, teollisen valmistuksen ja energiahuollon, veden puhdistuksen ja jakelun, jätevesi- ja jätehuollon, kotitalouden sekä valtion ja kunnat. Toimialajaottelu on EU:N standardiin perustuvan Tilastokeskuksen luokituksen TOL 2009 mukainen (Toimialaluokitus 2008, Tilastokeskus, Käsikirjoja 4, Helsinki 2008).

Teollisuuden ympäristönsuojelumenot -valmisaineisto sisältää: 
...
Teollisuuden ympäristönsuojelumenot -valmisaineistossa olevat tiedot ovat kerätty vuosittaisella, noin 2000 teollisuuden toimipaikalle lähetettävällä kyselyllä. Kysely koskee edellisenä vuonna toteutuneita ympäristönsuojelumenoja ja siihen on mahdollisuus vastata joko paperilomakkeella tai internetissä sähköisellä lomakkeella. Kyselyssä on tapahtunut muutos vuosien 2016 ja 2017, minkä vuoksi data on myös jaettu kahtia. Alle 250 henkilöä käsittäviltä yrityksiltä tiedot on kerätty otospohjaisesti. Kyselyn piiriin kuuluvat seuraavat toimialaluokituksen TOL 2008 pääluokat: B Kaivostoiminta ja louhinta (05 - 09), C Teollisuus (10 - 33), D Sähkö-, kaasu- ja lämpöhuolto, jäähdytysliiketoiminta (35) sekä pääluokasta E toimiala Veden otto, puhdistus ja jakelu (36). Toimialajaottelu on EU:n standardiin perustuvan Tilastokeskuksen luokituksen TOL 2008 mukainen (Toimialaluokitus 2008, Tilastokeskus, Käsikirjoja 4, Helsinki 2008). 

Noin 2000 toimipaikalle lähetetyn kyselyn vastausprosentti on viime vuosina ollut 70-80 %. Vastaukset on tarkistettu Tilastokeskuksessa mittausvirheiden minimoimiseksi. 
...
| `inv_ilma` | Ympäristöinvestoinnin arvo: Ulkoilman- ja ilmastonsuojelu (NOx, SOx, CO, VOC, CH4, CO2, CFC, N2O, hiukkaset) | — | — | INV |
| `inv_jate` | Ympäristöinvestoinnin arvo: Jätehuolto | — | — | INV |
| `inv_maa` | Ympäristöinvestoinnin arvo: Maaperän, pinta- ja pohjaveden suojelu | — | — | INV |
| `inv_melu` | Ympäristöinvestoinnin arvo: Melun ja tärinän torjunta | — | — | INV |
| `inv_vesi` | Ympäristöinvestoinnin arvo: Jäteveden käsittely (kiintoaine, BOD/COD, N, P, metallit, mikrobit) | — | — | INV |
| `inv_biodiv` | Ympäristöinvestoinnin arvo: Biologisen monimuotoisuuden ja maiseman suojelu | — | — | INV |
| `inv_sateil` | Ympäristöinvestoinnin arvo: Säteilyltä suojaaminen (pois lukien ydinvoimaloiden turvallisuus ja työsuojelu) | — | — | INV |
| `inv_ytuke` | Ympäristöinvestoinnin arvo: Ympäristöä koskeva tutkimus- ja kehittämistoiminta | — | — | INV |
| `inv_muu` | Ympäristöinvestoinnin arvo: Muut ympäristönsuojelutoimenpiteet ja ympäristöhallinnon kulut | — | — | INV |
| `inv_tyyppi` | Ympäristöinvestoinnin tyyppi: Ulkoinen tai sisäinen | — | — | INV |
| `men_ilma` | Tuotannon käyttö- ja kunnossapitokulut: Ulkoilman- ja ilmastonsuojelu | — | — | MEN |
| `men_jate` | Tuotannon käyttö- ja kunnossapitokulut: Jätehuolto | — | — | MEN |
| `men_maa` | Tuotannon käyttö- ja kunnossapitokulut: Maaperän, pinta- ja pohjaveden suojelu | — | — | MEN |
| `men_melu` | Tuotannon käyttö- ja kunnossapitokulut: Melun ja tärinän torjunta | — | — | MEN |
| `men_vesi` | Tuotannon käyttö- ja kunnossapitokulut: Jäteveden käsittely | — | — | MEN |
| `men_biodiv` | Tuotannon käyttö- ja kunnossapitokulut: Biologisen monimuotoisuuden ja maiseman suojelu | — | — | MEN |
| `men_sateil` | Tuotannon käyttö- ja kunnossapitokulut: Säteilyltä suojaaminen | — | — | MEN |
| `men_ytuke` | Tuotannon käyttö- ja kunnossapitokulut: Ympäristöä koskeva tutkimus- ja kehittämistoiminta | — | — | MEN |
| `men_muu` | Tuotannon käyttö- ja kunnossapitokulut: Muut ympäristönsuojelutoimenpiteet ja ympäristöhallinnon kulut | — | — | MEN |
| `men_tyyppi` | Tuotannon käyttö- ja kunnossapitokulun tyyppi: Palkkakulu, energia ja materiaalikustannus tai muu toimintameno | — | — | MEN |
| `opa_ilma` | Ostetut palvelut: Ulkoilman- ja ilmastonsuojelu | — | — | OPA |
| `opa_jate` | Ostetut palvelut: Jätehuolto | — | — | OPA |
| `opa_maa` | Ostetut palvelut: Maaperän, pinta- ja pohjaveden suojelu | — | — | OPA |
| `opa_melu` | Ostetut palvelut: Melun ja tärinän torjunta | — | — | OPA |
| `opa_vesi` | Ostetut palvelut: Jäteveden käsittely | — | — | OPA |
| `opa_biodiv` | Ostetut palvelut: Biologisen monimuotoisuuden ja maiseman suojelu | — | — | OPA |
| `opa_sateil` | Ostetut palvelut: Säteilyltä suojaaminen | — | — | OPA |
| `opa_ytuke` | Ostetut palvelut: Ympäristöä koskeva tutkimus- ja kehittämistoiminta | — | — | OPA |
| `opa_muu` | Ostetut palvelut: Muut ympäristönsuojelutoimenpiteet, korvaukset ja kompensaatiot sekä ympäristöhallinnon kulut | — | — | OPA |
| `opa_tyyppi` | Palvelutuottajan tyyppi: Yksityinen yritys tai julkinen taho | — | — | OPA |
...
Yhdistetty FIRM_PROD-aineistosta. Vuodet 14-16 tol08 ja vuodet 17-19 TOL08YR
...
0 = ei määritelty (2014 - 2016) 

1 = ulkoinen investointi 

2 = sisäinen investointi 

 

Ulkoiset investoinnit ovat investointeja päästöjen ja jätteiden käsittelyyn, puhdistamiseen ja ympäristöön leviämisen estämiseen. Ne eivät oleellisesti muuta tuotantoprosessin toimintaa, mutta voivat edellyttää pieniä muutoksia prosessitekniikassa. Tavallisesti ne ovat erilaisia puhdistimia ym. lisälaitteita tai esim. jätteiden käsittelyyn tarvittavia rakennelmia. Ulkoiset investoinnit ovat kokonaisuudessaan ympäristönsuojelun investointeja (ympäristönsuojeluosuus on yleensä 100 %). Investointi voi olla esim. kone, rakennus, maa-alue yms. 

 

Sisäiset ympäristönsuojeluinvestoinnit parantavat prosessin toimintaa ehkäisemällä päästöjen ja jätteiden syntymistä. Käytännössä ne tarkoittavat usein itse tuotantotekniikan uudistamista. Päästöjä vähentävät toimenpiteet muuttavat tuotantoprosessia siten, että tuotannosta aiheutuvien päästöjen muodostuminen suhteessa tuotantomääriin pienenee. 

 

Sisäiset investoinnit ovat tavallisesti vain osa tehdystä kokonaisinvestoinnista. Tällöin ilmoitetaan ympäristönsuojeluinvestoinnin osuus eli ympäristönsuojelun tasoa parantavista osainvestoinneista johtuva lisämeno ja sen osuus kokonaisinvestoinnista (%). Investointi voi olla esim. kone, rakennus, maa-alue yms.
...
12 = energia ja materiaalikustannus 

13 = muu toimintameno 

 

Ympäristönsuojeluun liittyvät menot koskevat kaikkia ympäristönsuojeluun liittyviä menoja lukuun ottamatta ympäristönsuojelupalveluiden ostoja ulkopuolisilta tahoilta. Menot eivät ole pelkästään oman laitoksen käyttö- ja kunnossapitokuluja, vaan ne sisältävät myös muitakin ympäristönsuojeluun kohdistuvia menoja, kuten esim. tutkimus- ja kehityskuluja (ilmoitetaan ”muina toimintamenoina” pois lukien palkkojen osuus). "
...
1 = ympäristöalan tai muu yritys 

2 = kunta ja/tai valtio 

 

Ostetut palvelut-osiossa ilmoitetaan myös hallinnolliset- ja viranomaismaksut kuten esim. ELY- maksut ja tuottajavastuuseen perustuvat sekä korvaukset- ja kompensaatio kulut. Ne kohdennetaan luokkaan ”Muut ympäristönsuojelutoimenpiteet, korvaukset ja kompensaatiot sekä ympäristöhallinnon kulut”. "
