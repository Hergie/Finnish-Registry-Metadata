# VAKA_TOIMIJA_TOIMIPAIKKA - kuukausipäivitteiset Vardaan pohjautuvat varhaiskasvatustoimija- ja -toimipaikkatiedot

- **Identifier:** `VAKA_20192026_jua_toimijaToimipaikka_001.xml`
- **DOI:** `vaka_2026-03_2026-03-06_ain_0001`
- **Temporal coverage:** 2019-01-01 - 2026-03-31
...
Tämän moduulin koko tietosisältö päivitetään kuukausittain, jonka myötä tiedot voivat revisioitua vaikuttaen tulosten toistettavuuteen. Tämä moduuli on tietosisällöltään myös laajempi verrattuna VAKA_TOIMIJA_TOIMIPAIKKA_SUPPEA -moduuliin. 
...
Moduuli koostuu seuraavista erillisistä tauluista: toimijan tiedot, toimipaikan tiedot, toimipaikan toimintapainotus, toimipaikan kielipainotus, toimipaikan toimintakieli, toimipaikan muutostiedot, PAOS-hallinnointi -linkkitaulu ja Ahvenanmaan summatason tiedot. Tietojen yhdistäminen taulujen välillä tapahtuu toimipaikkojen tai toimijoiden suojattujen tunnisteiden sekä päivämäärätietojen kautta.
...
VAKA_TOIMIJA_TOIMIPAIKKA-moduulin perusjoukko muodostuu Vardasta löytyvistä varhaiskasvatusta järjestävistä ja tuottavista toimijoista ja niihin liittyvistä toimipaikoista Suomessa.
...
<a href="https://stat.fi/tilasto/vaka">Varhaiskasvatustilasto</a></p> ja tilaston <p><a href="https://stat.fi/tilasto/dokumentaatio/vaka">dokumentaatio</a> (9.1.2026).
...
| `toimija_OID_jarjestaja_s` | Suojattu varhaiskasvatustoimijan tunniste (organisaatio-OID) varhaiskasvatuksen järjestäjälle. | — | — | paos-hallinnointi |
| `toimipaikka_OID_s` | Toimipaikan suojattu tunniste (organisaatio-OID). | — | — | toimipaikka |
| `toimipaikka_id_s` | Suojattu Vardan sisäinen tunniste toimipaikalle | — | — | toimipaikka, toimintapainotus, toimintakieli, kielipainotus |
| `alkamispvm` | Toiminnan alkamispäivämäärä. | — | — | toimipaikka, toimintapainotus, toimija, kielipainotus |
| `paattymispvm` | Toiminnan päättymispäivämäärä, jos tiedossa. | — | — | kielipainotus, toimija, toimintapainotus, toimipaikka |
| `y_tunnus_s` | Suojattu toimijan yritystunnus. | — | — | toimija |
| `yritysmuoto_k` | Karkeistettu toimijan yritysmuoto. | — | — | toimija, st_ahvenanmaa |
| `kuntakoodi` | Kuntakoodi | — | — | st_ahvenanmaa, toimija, toimipaikka |
...
| `kielikoodi` | Kielikoodi | — | — | toimintakieli |
| `toimintapainotuskoodi_k` | Toimipaikan toimintapainotus | — | — | toimintapainotus |
| `kielipainotuskoodi` | Kielipainotuksen kielikoodi | — | — | kielipainotus |
| `lkm_jako` | Havaintojen tarkempi jaottelu | — | — | st_ahvenanmaa |
| `lkm_tarkenne` | Tarkennin lukumäärän tyypille | — | — | st_ahvenanmaa |
| `lkm_tyyppi` | Lukumäärän tyyppi | — | — | st_ahvenanmaa |
...
TP03=Kuvataide,
TP04=Tiede,
TP05=Draama ja teatteritaide,
TP06=Ympäristö ja luonto,
TP07=Seikkailu,
TP08=Media,
TP99=Muu.

Erityiseen katsomukseen perustuva varhaiskasvatus (TP09) toiminnallisen painotus on sisällytetty TP99-luokkaan.
