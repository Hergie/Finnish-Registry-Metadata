...
| `P4` | 4. hakutoiveen pohjakouluvaatimus | — | — | — |
| `P5` | 5. hakutoiveen pohjakouluvaatimus | — | — | — |
...
| `PE4` | 4. hakutoiveen peruslinja | — | — | — |
| `PE5` | 5. hakutoiveen peruslinja | — | — | — |
...
| `KUN4` | 4. hakutoiveen sijaintikunta | — | — | — |
| `KUN5` | 5. hakutoiveen sijaintikunta | — | — | — |
...
| `TASO2` | Peruskoululaisen tasokurssit | — | — | — |
...
3 = Harjaantumisopetus 
4 = Vastaavan alan kouluasteen tutkinto/yhdistelmäopinnot (sis. 30 % vastaavan alan ammatillisia opintoja) 
5 = Kansakoulu 
6 = Mukautettu opetussuunnitelma 
7 = Oppivelvollisuuden suorittaminen keskeytynyt (ei päättötodistusta) 
8 = Opisto- tai amm. korkea-asteen tutkinto/nuorisoasteen koulutuskokeilun ammatillinen tutkinto (sis. lukion vähimmäisoppimäärän) 
9 = Abiturientti, ylioppilas tai lukion suorittanut/yhdistelmäopinnot tutkinto (sis. lukion vähimmäisoppimäärän)

#### `LK` — Lisäkoulutus

Saa arvoja 0-2, 6-9, X ja tyhjä, joiden sisällöstä ei ole tarkempaa tietoa.

#### `TYO` — Työkokemuspisteet

Saa arvoja 0-9, X ja tyhjä
...
Saa arvoja 1, 4, 9 ja tyhjä 

Muuttuja puuttuu vuodelta 1995
...
Saa arvoja 0-9, X ja tyhjä. Karkeistettu tasolle suomi=1, ruotsi=2, muu=3.
