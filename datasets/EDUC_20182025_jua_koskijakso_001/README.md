# EDUC_KOSKI_SUPPEA - Opiskeluoikeus_jakso
...
Suppea moduuli EDUC_KOSKI_SUPPEA: opiskeluoikeus_jakso
...
Tilajakson alkupäivä.

#### `loppu` — Tilajakson loppupäivä

Tilajakson loppupäivä.
...
Jos opiskelijalla on useita peräkkäisiä saman tilan jaksoja, tässä kentässä näkyy näistä ensimmäisen alkamispäivä.

#### `opintojen_rahoitus` — opintojen rahoitus

Tieto siitä, mikä rahoitusmuoto opinnoilla on ollut rivin kuvaaman aikajakson aikana. Käytettävä koodisto: https://opintopolku.fi/koski/dokumentaatio/koodisto/opintojenrahoitus/latest.

Opintojen_rahoitus='14' tarkoittaa jotpa-rahoitettuja opintoja.
