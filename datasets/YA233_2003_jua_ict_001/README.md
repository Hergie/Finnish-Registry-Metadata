# FIRM_ICT Tietotekniikka ja sähköinen kauppa yrityksissä 2003 (YA233)

- **Identifier:** `YA233_2003_jua_ict_001.xml`
- **DOI:** `work_2017-12_2017-12-04_ain_0005`
- **Temporal coverage:** 2003-01-01 - 2003-12-31
- **Published:** 2018-03-19
- **Organisation:** Tilastokeskus
- **Variable count:** 152
- **Observation count:** 3,279
...
| `ETATYO` | yrityksessä etätyön tekijöitä (1=kyllä, 0=ei) | — | — | — |
...
| `KOTMUOK` | asiakaskohtaisesti muokattavat kotisivut (1=kyllä, 0=ei) | — | — | — |
...
| `TRUST` | kotisivuilla luotettavuusmerkintä Trust (1=kyllä, 0=ei) | — | — | — |
| `ADR` | vaihtoehtoiset riidanratkaisumenetelmät (1=kyllä, 0=ei) | — | — | — |
| `PALVAL` | asiakaspalvelu-/valitusmenetelmät (1=kyllä, 0=ei) | — | — | — |
...
| `TYPEFACT` | sähköisen kaupan teknikka EDIFACT (1=kyllä, 0=ei) | — | — | — |
| `EDIOSUUS1` | EDIFACT osuus EDI liikevaihdosta (%) | — | — | — |
| `TYPEXML` | sähköisen kaupan tekniikka XML/EDI (1=kyllä, 0=ei) | — | — | — |
| `EDIOSUUS2` | XML/EDI osuus EDI liikevaihdosta (%) | — | — | — |
| `TYPEMUU` | muu sähköisen kaupan tekniikka (1=kyllä, 0=ei) | — | — | — |
| `EDIOSUUS3` | muun tekniikan osuus EDI liikevaihdosta (%) | — | — | — |
| `TYPEEOS` | EDI-tyyppi, ei osaa sanoa | — | — | — |
...
| `ITGEITOI` | tavaran tai palvelujen toimitus ei integroitu sähk järjestelmiin | — | — | — |
| `ITGEOTOI` | ei osaa sanoa onko tavaran tai palvelujen toimitus ei integroitu sähk järjestelmiin | — | — | — |
...
| `ITGEPAL` | edi integrotu myynnin jälk palveluihin (1=kyllä, 0=ei) | — | — | — |
| `ITGIPAL` | internet integroitu myynnin jälk palveluihin (1=kyllä, 0=ei) | — | — | — |
| `ITGEIPAL` | ei integrointia myynnin jälk palveluihin | — | — | — |
| `ITGEOPAL` | ei osaa sanoa onko integrointia myynnin jälk palveluihin | — | — | — |
...
| `INTELOG` | autom yhteys logistiikkaan (1=kyllä, 0=ei) | — | — | — |
| `INTEMARK` | autom yhteys markkinointiin (1=kyllä, 0=ei) | — | — | — |
| `INTETOIM` | autom yhteys tavarantoimittajat (1=kyllä, 0=ei) | — | — | — |
| `INTEASIAK` | autom yhteys asiakkaiden järj (1=kyllä, 0=ei) | — | — | — |
| `TURVA` | turvattu palvelin (1=kyllä, 0=ei) | — | — | — |
| `PALO` | palomuuri (1=kyllä, 0=ei) | — | — | — |
| `SALA` | Salasanasuojaus (1=kyllä, 0=ei) | — | — | — |
| `VARM` | Varmuuskopiointi (1=kyllä, 0=ei) | — | — | — |
| `DIGI` | digitaalinen allekirjoitus (1=kyllä, 0=ei) | — | — | — |
| `PIN` | muu todennusmekanismi, esim. PIN-koodi (1=kyllä, 0=ei) | — | — | — |
| `VIRTOR` | virustorjuntaohjelma (1=kyllä, 0=ei) | — | — | — |
| `TURPAL` | tietoturvapalvelun tilaus (1=kyllä, 0=ei) | — | — | — |
| `MENETYS` | tietokonevirus aiheuttanut tiedon tai työajan menetyksiä (1=kyllä, 0=ei) | — | — | — |
| `TUNK` | luvaton tunkeutuminen yrityksen tietojärjestelmään (1=kyllä, 0=ei) | — | — | — |
| `KIRIS` | yrityksen dataan tai ohjelmistoihin kohdistuva kiristys tai uhkailu (1=kyllä, 0=ei) | — | — | — |
| `PAIV` | tietoturvallisuusjärjetelmien päivitys 3 kk aikana (1=kyllä, 0=ei) | — | — | — |
| `yr_tol95` | Toimialaluokitus 1995, yritysrekisteri | — | — | — |
| `yr_hk_suuruusluokka` | Henkilöstön suuruusluokka, yritysrekisteri | — | — | — |
| `yr_kotikunta` | Yrityksen kotikunta | — | — | — |
...
| `yr_tol2002` | Toimialaluokitus 2002, yritysrekisteri | — | — | — |
...
| `julkeuro` | nettimyynti julkiselle sektorille euroina | — | — | — |
...
| `typefacteur` | lopullinen edi-myynti edifact:n kautta (euro) | — | — | — |
| `typexmleur` | lopullinen edi-myynti xml:n kautta (euro) | — | — | — |
| `typemuueur` | lopullinen edi myynti muun verkon kautta (euro) | — | — | — |
...
| `HLOKERR` | EU-laskelmien henkilökuntamäärään perustuva korotuskerroin | — | — | — |
...
Internet-kauppaan tai sen aloittamiseen liittyvät ongelmat
