# FIRM_ICT Tietotekniikka ja sähköinen kauppa yrityksissä 2006 (YA233)

- **Identifier:** `YA233_2006_jua_ict_001.xml`
- **DOI:** `work_2017-12_2017-12-04_ain_0002`
- **Temporal coverage:** 2006-01-01 - 2006-12-31
- **Published:** 2018-03-12
- **Organisation:** Tilastokeskus
- **Variable count:** 150
- **Observation count:** 3,265
...
| `ETAKOT` | etäyhteys kotoa (1=kyllä, 0=ei) | — | — | — |
| `ETAAS` | etäyhteys asiakkaan/yht.työkumpp toimipaikasta (1=kyllä, 0=ei) | — | — | — |
| `ETAOMA` | etäyhteys oman yrityksen muista toimpisteistä (1=kyllä, 0=ei) | — | — | — |
| `ETAMAT` | etäyhteys työmatkan aikana (1=kyllä, 0=ei) | — | — | — |
| `REKRY` | it-taitoisen henkilöstön rekrytointia (1=kyllä, 0=ei) | — | — | — |
| `REKKAYT` | ongelmia käyttäjien rekrytoinnissa (1=kyllä, 0=ei) | — | — | — |
| `REKIT` | ongelmia itammattilaisten rekrytoinnissa (1=kyllä, 0=ei) | — | — | — |
| `REKPALK` | vaikea täyttää syy: palkka (1=kyllä, 0=ei) | — | — | — |
| `KORVAUS` | paperipostin korvaaminen sähk välineillä (ei lainkaan; jonkin verran; merkittävästi; pääosin tai kokonaan; eos) | — | — | — |
...
| `EDITUL` | lähettänyt tulliasiakirjoja (1=kyllä, 0=ei) | — | — | — |
| `EDIKUL` | lähett tai vastaanott kuljetusasiakirjoja | — | — | — |
...
| `EMYEI` | ei ottanut vastaan edi tilauksia | — | — | — |
...
| `TURONG` | Turvallisuusongelmia (1=kyllä, 0=ei) | — | — | — |
...
Johdettu henkilöstön määrään liittyvä taustamuuttuja.
