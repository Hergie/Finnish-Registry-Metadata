# TAX_XPER Työnantajan tai suorituksen maksajan vuosi-ilmoitus verohallinnolle (2018)

- **Identifier:** `TAX_2018_jua_XPER_002.xml`
...
| `palkeipv` | Palkka, josta ei sairausvakuutusmaksua | — | — | — |
...
| `autovere` | Verotettavan autoedun määrä | — | — | — |
| `taperkoa` | Työnantajan perimä korvaus (autoetu) | — | — | — |
| `ikaryhma` | Ikäryhmä, autoetu | — | — | — |
...
| `vervapkk` | Verovapaat kustannusten korvaukset | — | — | — |
| `kilometr` | Kilometrikorvaus, km | — | — | — |
| `kilomkor` | Kilometrikorvaus | — | — | — |
| `verkuko` | Veronalaiset kustannusten korvaukset | — | — | — |
...
| `eivaltuve` | Ei välitetä tuloverotukseen | — | — | — |
...
| `ulkomvero` | Ulkomaille peritty vero | — | — | — |
| `maatunnus` | Maatunnus | — | — | — |
...
Eläke- ja työttömyysvakuutusmaksut yhteensä. Palkoista maksetut  ja työnantajan eläkeyhtiöille ilmoittamat työttömyysvakuutusmaksut ja työeläkemaksut yhteensä, euroa (€).
...
Verovapaat kustannusten korvaukset  euroa (€). Sisältää verovapaiden päivärahojen ja ateriakorvausten yhteismäärän, sekä seuraavat ulkomaantyöskentelyyn liittyvät verovapaat edut,  verovelvollisen ja hänen perheenjäsenensä muutto- ja matkakustannukset työntekovaltioon ja takaisin,  työnantajan ulkomailla kustantama tavanomainen yksityinen palveluhenkilöstö, työnantajan kustantama lasten perus- ja lukiotason koulutus.
...
Palkansaajalle maksetut kustannusten korvaukset, joita ei ole otettu mukaan palkan määrään eikä toimitettu ennakonpidätystä. Tässä ilmoitetaan työnantajan palkansaajalle maksamat muut työstä valittömästi aiheutuneet kustannukset, kuten työvälineiden tai materiaalien hankinnasta korvatut kulut, pl. työmatkakustannukset.
