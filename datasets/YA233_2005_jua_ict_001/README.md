# FIRM_ICT Tietotekniikka ja sähköinen kauppa yrityksissä 2005 (YA233)

- **Identifier:** `YA233_2005_jua_ict_001.xml`
- **DOI:** `work_2017-12_2017-12-04_ain_0003`
- **Temporal coverage:** 2005-01-01 - 2005-12-31
- **Published:** 2018-03-12
- **Organisation:** Tilastokeskus
- **Variable count:** 152
- **Observation count:** 3,518
...
|---|---|---|---|---|
| `flag5` | extra imputoitu | — | — | — |
| `extra1` | extra ennen imputointia | — | — | — |
| `flag4` | intra imputoitu | — | — | — |
| `intra1` | intra ennen imputointia | — | — | — |
| `flag3` | lahiv imputoitu | — | — | — |
| `lahiv2` | lahiv ennen imputointia | — | — | — |
...
| `flag2` | inethlo imputoitu | — | — | — |
| `inethlo2` | inethlo ennen imputointia | — | — | — |
| `flag1` | tkhlo imputoitu | — | — | — |
| `tkhlo1` | tkhlo ennen imputointia | — | — | — |
| `lahiv1` | alkuperäinen vastaus LAN ilman WLAN | — | — | — |
...
| `typeieur` | lopullinen edi-myynti muun kuin netin kautta | — | — | — |
...
| `henlkm` | Henkilöstön määrä, yritysrekisteri | — | — | — |
...
| `yr_yrek_liikevaihto1` | Yritysrekisterin liikevaihto | — | — | — |
...
| `ULPC` | PC-ympäristön käyttö/ylläpito (1=kokonaan ulkop, 2=pääosin ulkop, 3=yhtä paljon ulkop ja oma, 4=pääosin oma, 5=kokonaan oma, 0=eos, ei relevantti | — | — | — |
| `ULPALV` | Palvelinten  käyttö/ylläpito:  (1=kokonaan ulkop, 2=pääosin ulkop, 3=yhtä paljon ulkop ja oma, 4=pääosin oma, 5=kokonaan oma, 0=eos, ei relevantti | — | — | — |
...
| `ULIYR` | Internet/extranet kauppapaikka yritysasiakkaille: (1=kokonaan ulkop, 2=pääosin ulkop, 3=yhtä paljon ulkop ja oma, 4=pääosin oma, 5=kokonaan oma, 0=eos, ei relevantti | — | — | — |
| `ULIYK` | Internet/extranet kauppapaikka yksityisille asiakkaille: (1=kokonaan ulkop, 2=pääosin ulkop, 3=yhtä paljon ulkop ja oma, 4=pääosin oma, 5=kokonaan oma, 0=eos, ei relevantti | — | — | — |
| `ULKOYL` | Internet-sivujen ylläpito (1=kokonaan ulkop, 2=pääosin ulkop, 3=yhtä paljon ulkop ja oma, 4=pääosin oma, 5=kokonaan oma, 0=eos, ei relevantti | — | — | — |
| `ULKOSU` | Internet-sivujen suunnnittelu&kehittäminen: (1=kokonaan ulkop, 2=pääosin ulkop, 3=yhtä paljon ulkop ja oma, 4=pääosin oma, 5=kokonaan oma, 0=eos, ei relevantti | — | — | — |
| `PAIV` | tietoturvallisuusjärjetelmien päivitys 3 kk aikana (1=kyllä, 0=ei) | — | — | — |
| `MUUONG` | muu  turvallisuusongelma (1=kyllä, 0=ei) | — | — | — |
...
| `PIN` | muu todennusmekanismi, esim. PIN-koodi | — | — | — |
...
| `TYPEEOS` | EDI-tyyppi, ei osaa sanoa (1=kyllä, 0=ei) | — | — | — |
...
| `KOTMOBIL` | kotisivut käytettävissä mobiililaitteella | — | — | — |
| `KOTMYJAL` | kotisivuilla myynnin jälkeisiä palveluita (1=kyllä, 0=ei) | — | — | — |
| `KOTMUOK` | asiakaskohtaisesti muokattavat kotisivut | — | — | — |
| `KOTDIGI` | tuotteiden toimitus sähköisesti | — | — | — |
...
| `YHTEOS` | Internet-yhteystyyppi Ei osaa sanoa (1=kyllä, 0=ei) | — | — | — |
| `MOBIL` | netyhteys matkapuh (1=kyllä, 0=ei) | — | — | — |
| `KIINMUU` | muu laajakaista (1=kyllä, 0=ei) | — | — | — |
| `XDSL2` | muu laajakaista > 2Mbps (1=kyllä, 0=ei) | — | — | — |
...
| `NETVIRASI` | täysi sähköinen asiointi viranomaisten kanssa (1=kyllä, 0=ei) | — | — | — |
...
| `NETDIGI` | digitaalisten tuotteiden tai palveluiden vastaanotto | — | — | — |
