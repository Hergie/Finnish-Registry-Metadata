# EDUC_KOSKI_2ASTE - Ammatillinen_alemmat

- **Identifier:** `EDUC_20182025_jua_koskiammatillinenalemmat_001.xml`
...
Laaja moduuli EDUC_KOSKI_2ASTE: ammatillinen_alemmat
alemmat-taulu sisältää kaikki ammatillisen koulutuksen alemmat osasuoritukset. Sisältää tietoja kuten arvosanat, laajuus ja arviointipäivä. Kaikki tämän taulun rivit ovat osa jotain ammatillinen_ylemmat-taulun suoritusta.
Yhdistää tietoja KOSKI raporttikannan tauluista: r_opiskeluoikeus, r_paatason_suoritus, r_osasuoritus, r_henkilo.

HUOM. Taulussa on tuplarivejä, joita ei ole poistettu.
...
| `ylempi_osasuoritus_id` | Ylempi osasuoritus id | — | — | — |
...
Sen päätason suorituksen koodiarvo, johon tutkinnonosan suoritus kuuluu

#### `paataso_koulutusmoduuli_koodisto` — Päätaso koulutusmoduuli koodisto

Lisätietoa https://opintopolku.fi/koski/dokumentaatio/koodistot . Ammatillisen tutkintokoulutuksen suorituksilla on tässä kentässä arvo 'koulutus'
...
Koodisto, josta osasuorituksen koodiarvo löytyy. Jos kyseessä paikallinen suoritus (koulutusmoduuli_paikallinen='t'), niin koodisto on tyhjä. Lisätietoa: https://opintopolku.fi/koski/dokumentaatio/koodistot
...
Yksilöi ylemmän osasuorituksen johon suoritus sisältyy. Ylempi osasuoritus löytyy vastaavalla avaimella ammatillinen_ylemmat -taulusta.
 Ei pysyvä tunnus.
