# FIRM_EMPENT Yrityskohtaiset henkilöstöominaisuudet
...
- **Variable count:** 36
- **Observation count:** —
- **Population:** 16-70-vuotiaat henkilöt yritysrekisterin yrityksissä, joille löytyy vähintään 1 henkilö FOLK/FLEEDistä
...
Tilastoon tulevat yritykset ja toimipaikat, jotka ovat toimineet yli puoli vuotta tilastovuonna ja jotka ovat työllistäneet enemmän kuin puoli henkilöä tai joiden liikevaihto on ylittänyt vuosittain määritellyn tilastorajan (esim. 10 595 euroa vuonna 2012).
