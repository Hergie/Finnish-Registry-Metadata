# Harmonisoitu palkkarakennepaneeli - kuntasektori 1995-2023

- **Identifier:** `SES_19952023_jua_harkun_001.xml`
- **DOI:** `ati_2014-05_2014-05-15_ain_0001`
- **Temporal coverage:** 1995-01-01 - 2023-12-31
- **Published:** 2018-05-21
- **Organisation:** Tilastokeskus
- **Variable count:** 32
- **Observation count:** 12,529,686
...
Kuntasektorin harmonisoitu palkkarakennepaneeli vuosilta 1995-2023 tarjoaa työsuhdetason tietoa palkansaajien
(palkatuista) tunneista, palkoista ja palkanosista + yksilötason tietoa työntekijän iästä, koulutuksesta yms. + tietoa työsuhteesta vastaavan kunnan tai kuntayhteisön paikallisyksikön toimialasta jne (yhteensä 32 muuttujaa). Tilasto on kokonaisaineisto kattaen kaikki kuntien ja kuntayhtymien työ- ja virkasuhteiset palkansaajat (12529686 työsuhdehavaintoa). 

Tiedot on harmonisoitu keskenään vertailukelpoisiksi sekä suhteessa yksityisen ja valtiosektorin vastaaviin palkkatilastokäsitteisiin että yli vuosien. Siinä missä alkuperäinen palkkarakenneaineisto takaa sektorien välisen vertailtavuuden saman tilastovuoden sisällä, takaa harmonisoitu palkkarakenneaineisto lisäksi vielä sen, että käytettävät muuttujat todella mittaavat/kuvaavat samaa asiaa tilastovuodesta riippumatta. Vuosien yli harmonisoinnissa noudattavat harmonisoidut muuttujat vuoden 2023 kuntasektorin palkkarakenneaineiston yhteydessä käytettyjä muuttujien muodostussääntöjä ja luokitusmuuttujien luokitusversioita. HAR_ -etuliite muuttujan nimen alussa viittaa yli ajan harmonisoituun muuttujaan. Loput mukaan otetuista muuttujista olivat yli ajan harmonisoidussa muodossa jo vuosipoikkileikkausaineistoissa.
...
| `VUOSI` | Tilastovuosi | — | — | — |
| `AINE` | Aineistotunnus | — | — | — |
| `hid_e` | Suojattu henkilötunniste | — | — | — |
| `YRTUN_s` | Suojattu kuntayksikkötunnus | — | — | — |
| `PYKSKUNTA` | Paikallisyksikön sijaintikunta. Aineiston harmonisointivuoden (2023) kuntatunnukset: https://stat.fi/fi/luokitukset/kunta/kunta_1_20230101 | — | — | — |
...
| `HAR_BASIS1` | Havainnon mukaanottamisehto HAR_TUNTIPALKKA-muuttujaa koskeville laskelmille. | — | — | — |
...
Tilaston tilastointivuosi. Tässä tiedostossa 1995-2023. Tiedot kuvaavat pääasiassa vuoden viimeistä neljännestä. Vuosittainen tilastointiajankohta on lokakuu ja tilastointijakso voi pisimmillään olla yksi kuukausi (jos ilmoitusjakso ei satu täysin lokakuulle, niin ilmoitusajankohdaksi valitaan  syys–lokakuulle osuvat viikot).

#### `AINE` — Aineistotunnus

Aineistotunnuksella erotetaan eri tiedonantajalähteet toisistaan. Kuntasektorilla mahdollisia arvoja vv. 1995-2023 vain yksi, 
K=kuntien ja kuntayhteisöjen palkansaajat.

#### `hid_e` — Suojattu henkilötunniste

Suojattu TK:n tutkimusaineistoissa käytettävä henkilötunniste

#### `YRTUN_s` — Suojattu kuntayksikkötunnus

#### `PYKSKUNTA` — Paikallisyksikön sijaintikunta. Aineiston harmonisointivuoden (2023) kuntatunnukset: https://stat.fi/fi/luokitukset/kunta/kunta_1_20230101

Tieto toimipaikan tai paikallisyksikön sijaintikunnasta. Tieto saadaan yritysrekisteristä (YTY) tai suoraan palkka-aineistosta. Aineiston harmonisointivuoden (2023) kuntatunnukset: https://stat.fi/fi/luokitukset/kunta/kunta_1_20230101.
