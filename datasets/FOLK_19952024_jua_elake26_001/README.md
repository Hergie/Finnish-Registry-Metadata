...
- **Variable count:** 7
- **Observation count:** —
- **Population:** Henkilöt, jotka ovat asuneet vakituisesti Suomessa ja saaneet eläkettä vuodesta 1995 alkaen.
- **Source:** Kansaneläkelaitoksen ja Eläketurvakeskuksen rekisterit eläkkeensaajista, Tulorekisteri
...
|---|---|---|---|---|
| `vuosi` | Vuosi | — | — | — |
| `shnro` | Suojattu TK:n henkilönumero | — | — | Vaestorakenne |
