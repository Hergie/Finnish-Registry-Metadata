# FIRM_FSS Tilinpäätösaineisto 2021-2024

- **Identifier:** `FIRM_20132021_jua_FSS_001.xml`
...
HUOM. Yritysten rakennetilastoissa on tehty syksyllä 2022 uudistuksia, jotka aiheuttavat aikasarjakatkoksen vuosien 2020–2021 välille.

Aineisto sisältää kattavasti tiedot kaikista liikeyrityksistä lähes kaikilta toimialoilta. Joidenkin toimialojen osalta tietoja käytettäessä on kuitenkin huomioitava tietojen heikko laatutaso. Toimialat 01-03 ei ole käytössä tilastossa, joten niiden laatua ei ole tarkastettu. Toimialoilla 02 ja 03 liikevaihtotiedot ovat ok, mutta toimialalla 01 niitä ei ole tarkistettu, eikä niitä suositella käytettävän. Henkilöstömäärät ja palkkasummat taas ovat kunnossa kyseisillä toimialoilla 01-03.

Tilastoyksikkönä on yritys (oikeudellinen yksikkö). Aineisto ei sisällä konserneja eikä yritysten toimipaikkoja. Valtion ja kuntien uusimuotoiset liikelaitokset sisältyvät aineistoon. Kuvausalueen ulkopuolelle jäävät julkisen sektorin viranomaisyksiköt sekä kotitalouksia palvelevat voittoa tavoittelemattomat yhteisöt (sektoriluokka 15) sekä ne maatalouden yksiköt, jotka eivät täytä tilastointikriteerejä. Huom. alkutuotannon toimialoilta ei muutamaa poikkeusta lukuun ottamatta kysytä liikevaihdon ja kulujen erittelyitä tilinpäätöstiedustelussa. Tiedot eivät siis näillä toimialoilla ole luotettavia, 
Yksilöivänä tunnuksena on yrityksen liike- ja yhteisötunnus eli y-tunnus (suojattu).

Tiedot kerätään osaksi suoraan yrityksiltä ja osaksi hyödyntämällä verohallinnon elinkeinoveroaineistoa. Yritysten tuloslaskelman ja taseen lisätietojen suorassa tiedonkeruussa ovat mukana kaikki yli 50 henkilöä työllistävät yritykset. Lisäksi 10 - 50 henkilöä työllistävistä yrityksistä tiedusteluun on valittu yritykset satunnaisotannalla. Tiedustelussa on myös joitain alle 10 henkilöä työllistäviä yrityksiä sekä kaikki markkinaehtoiseti kunnalliset liikelaitokset. Pienempien ja vastaamattomien yritysten tuloslaskelma- ja tasetiedot saadaan hallinnollisista aineistoista (Elinkeinoverotusrekisteri, EVR) ja muut tiedot imputoidaan käyttäen hyväksi hallinnollisista aineistoista sekä Tilastokeskuksen tiedusteluista saatuja tietoja (Tilkes).
...
Vuonna 2013 siirtyminen yritystietovarastojärjestelmään ja tilinpäätöstilastojen ja yritysrekisterin vuositilaston yhdistyminen Yritysten rakenne- ja tilinpäätöstilastoksi vaikuttavat kuvausalueen laajuuteen ja sisältöön, mm. toimialojen, liikevaihdon, henkilöstön ja yritysjärjestelyiden käsittelyyn ja laatumuuttujiin. Tämä näkyy tilastoitavien yksiköiden lukumäärän kasvuna. Lisäksi erilaiset käsittelysäännöt, esimerkiksi laatumuuttujat ja nollien merkitseminen, ovat muuttuneet. Vuoteen 2012 asti käytössä olleet muuttujanimet on merkitty kuvauksessa kunkin muuttujan kohdalle sulkuihin. Vuodesta 2013 lähtien FIRM_FSS-aineiston tilastoyksiköt vastaavat FIRM_ENTER-tilastoyksiköitä vielä aiempaa paremmin.

***Tilastovuoden 2015 muutokset: 

Säätiöt nyt mukana lomakkeelta 6C, jos ylittävät tilastorajat. Toimialalla L/68 (kiinteistöt) tasetta koskevissa tiedoissa laatuvaraus.

***Tilastovuoden 2017 muutokset:

Lomakkeelta 6B poistui liiketoiminnan tuotoista erät henkilökohtaisen tulolähteen tuotot ja maatalouden tulolähteen tuotot sekä vastaavat erät liiketoiminnan muista kuluista. Mm. vuokratuotot on aikaisemmin ilmoitettu henkilökohtaisen tulolähteen tuottoina. Näitä vastaavat tiedot saadaan nyt lomakkeilta 7A ja 7M ja lomakkeilta saadut tiedot on konvertoitu aineistoon. Tämä aiheutti kiinteistöalalle ison muutoksen, koska tällä toimialalla lähes kaikki tuotot ilmoitetaan lomakkeella 7A. Tämän toimialan vuokratuotot on nyt viety liikevaihdoksi, mikä näkyy liikevaihdon kasvuna. Nämä tuotot sisältyivät aikaisemmin liiketoiminnan muihin tuottoihin (henkilökohtaisen tulolähteen tuottoihin). Muilla toimialoilla vuokratuotot ovat edelleen muissa tuotoissa. Kiinteistöalalla on myös hyödynnetty verolomakkeelta 4 (Asunto- JA kiinteistöyhteisö) saatuja tietoja.
Kirjanpitolain uudistuksen yhteydessä satunnaiset erät poistuivat tuloslaskelmakaavasta sekä verolomakkeelta. Tilastovuodesta 2017 lähtien maksetut ja saadut konserniavustukset esitetään tilinpäätössiirtojen yhteydessä omina erinään. Aikaisemmin nämä erät sisältyivät Satunnaisiin tuottoihin ja kuluihin. Muut satunnaisiin eriin kirjatut tuotot tai kulut ovat nyt liiketoiminnan muissa tuotoissa tai kuluissa.Tilinpäätösaineiston tunnusluvuissa kokonaistulos on laskettu siten, että se on vertailukelpoinen aikaisempiin vuosiin. Eli konserniavustukset on laskettu mukaan kokonaistulokseen.

***Tilastovuoden 2018 muutokset:  
...
Muutos vaikuttaa tilinpäätöstietoihin ohjelmoinnin ja kustantamisen toimialoilla. Muutos näkyy tilastovuoden 2018 luvuissa, eivätkä ne ole näiden toimialojen osalta vertailukelpoisia edellisvuoteen.

***Tilastovuoden 2021 muutokset:
...
Aineisto sisältää lisäksi vuodelle 2021 toimialalta K tiedot liikevaihto, jalostusarvo, henkilöstömäärä, palkkasumma, yritysten lkm,  tuotannon bruttoarvo, käyttökate, henkilöstökulut, sosiaaliturvamaksut, investoinnit, vuokratyövoiman kustannukset ja ostot yhteensä. Muissa toimialan tiedoissa on merkittävä laaturiski.
...
Aikaisemmin aineistoon oli rajattu vain ne yritykset, joille VuosiTilastonYksikko=1. Nyt rajauksesta on luovuttu, ja aineistossa on enemmän rivejä. Aineistossa on kuitenkin yhä seuraava toimialarajaus: Ei valita julkista hallintoa, maanpuolustusta tai pakollista sosiaalitointa: tol2008Vuosi ei ole 84  tai 97.


Tietoa imputoinneista ja niitä koskevista laatumuuttujista:

Aineistoa rajatessa kannattaa erityisesti huomioida laatukoodien merkitys tietojen luotettavuutta arvioitaessa.
Noin 50 prosentille kaikista yrityksistä tietoja muokataan editointi- ja imputointiprosessin kautta. Tarkistuskoodit on jaoteltu muuttujaryhmittäin. TILKES-tiedustelun muuttujat imputoidaan kaikille, paitsi tiedusteluun vastanneille yrityksille, jotka on manuaalisesti käyty läpi ja hyväksytty / massahyväksytty (n. 5000 yritystä).

TilaVuosi-muuttujan arvo kertoo käsittelyn tilan. 

Laatumuuttujat:
Tuloslaskelman laatumuuttujat
-    TuloverolaskTarkTulo
-    TuloverolaskTarkKulu
-    VarallLaskTarkKoodiTulosTase
 
Taseen laatumuuttujat
-    VarallLaskTarkKoodiVarat
-    VarallLaskTarkKoodiVelat
-    VarallLaskTarkKoodiOmap

Näillä muuttujilla on käytössä luokitus TulosTaseLaatu
01                        Tiedot OK
02                        Virheellistä muuttujaa korjattu Outlier-menetelmällä
03                        Virheellistä muuttujaa korjattu skaalausmenetelmällä
04                        Virheellistä muuttujaa korjattu imputoimalla edellisvuoden tiedoista
05                        Virheellistä muuttujaa korjattu imputoimalla luovuttajayrityksen tiedoista
06                        Virheellistä muuttujaa korjattu useammalla menetelmällä
07                        Tiedoissa virhe
08                        Tase tyhjätty fuusion takia     EI KÄYTÖSSÄ
ZZ                        Tieto puuttuu

Jos tuloslaskelman tai taseen laatumuuttujien arvot ovat 04, niin koko tuloslaskelma tai tase on tuotettu edellisen vuoden tietojen perusteella. Jos kaikki kolme laatumuuttujaa saavat arvon 05, niin tuloslaskelman tai taseen tiedot on imputoitu luovuttajayrityksen tiedoilla.
 
Laatukoodi erittInvLaatukoodi on 1 kun tilkes-tiedot on hyväksytty ja 0 kun tilkes-tiedot on imputoitu tai niitä on muuten automaattisesti korjattu.
 
Tilamuuttuja tilavuosi ohjaa aineiston käsittelyä. Siitä ei välttämättä selviä, onko yksikkö kyselyssä vai ei. Jos halutaan erottaa ne kyselyssä olleet, jotka ovat vastanneet ja joiden tiedot on hyväksytty, niin ne saa erotettua ErittInvLaatukoodi-muuttujalla. Se vastaa vanhaa impu-muuttujaa.
 
Manuaalisesti ja automaattisesti hyväksytyt tilkes-tiedot saa rajattua mukaan erittInvLaatukoodi-muuttujan arvolla 1 sekä tilaVuosi=8 -rajauksella (erittInvLaatukoodi=1 or tilaVuosi=’8’). Kun tilaVuosi on 8, yksikkö on hyväksytty automaattisesti (tuloslaselma, tase ja tilkes), mutta erittInvLaatukoodi voi silti olla 0.
 
Jos halutaan kaikki ne, joilla tuloslaskelma ja tase on hyväksytty joko manuaalisesti tai automaattisesti, mutta tilkes-tiedot voivat olla joko imputoituja tai myös hyväksyttyjä, rajataan mukaan tilaVuosi in (’2’,’4’,’5’,’7’,’8’).
...
| `konserniID_s` | Suojattu konsernitunnus | — | — | taustatiedot |
...
| `Fuusiotieto` | Fuusiokorjaustieto | — | — | taustatiedot |
...
| `ku_Edustus` | Edustuskulut | € | — | kulut |
| `ku_Elake` | Eläkekulut | € | — | kulut |
| `ku_FuusioTappio` | Fuusiotappio verottajalta | € | — | kulut |
| `ku_HenkilostoYht` | Henkilöstökulut yhteensä | € | — | kulut |
| `ku_HenkKohtTulolahde` | Henkilökohtaisen tulolähteen kulut | € | — | kulut |
| `ku_KayttOmaisArvoAlen2` | Käyttöomaisuuden arvonalentumiset | € | — | kulut |
| `ku_KayttOmaisOsakLuovTappio` | Ko osakkeitten luovutus- ja purkutappiot | € | — | kulut |
| `ku_konsTukiSaamArvoAlen` | Konsernituki ja saamisten arvonalentumiset | € | — | kulut |
| `ku_KorkoOmistusYhtYri` | Korkokulut omistusyhteysyrityksille | € | — | kulut |
| `ku_KorkoSamaKonsYri` | Korkokulut saman konsernin yrityksille | € | — | kulut |
| `ku_Lahjoitus` | Annetut lahjoitukset | € | — | kulut |
| `ku_Leasing` | Leasingmaksut | € | — | kulut |
| `ku_LiiketoimMuutYht` | Liiketoiminnan muut kulut yhteensä | € | — | kulut |
| `ku_MaatalTulolahde` | Maatalouden tulolähteen kulut | € | — | kulut |
| `ku_MuuHenkSivu` | Muut henkilösivukulut | € | — | kulut |
| `ku_MuuKayttOmaisLuovTappio` | Muut käyttöomaisuuden luovutustappiot | € | — | kulut |
| `ku_MuuRah` | Muut rahoituskulut | € | — | kulut |
| `ku_MuuRahOmaisMenetArvoAlen` | Muun rahoitusomaisuuden menetykset ja lopulliset arvonalentumiset | € | — | kulut |
| `ku_MuutKorko` | Muut korkokulut | € | — | kulut |
| `ku_MuuVahKelp` | Muut vähennyskelvottomat kulut | € | — | kulut |
| `ku_MuuVahKelpLiiketoimMuu` | Muut vähennyskelpoiset liiketoiminnan muut kulut | € | — | kulut |
| `ku_MyyntisaamArvoAlen` | Myyntisaamisten arvonalentumiset | € | — | kulut |
| `ku_OstotYht` | Ostot tilikauden aikana | € | — | kulut |
| `ku_PakollVaraus` | Pakolliset varaukset | € | — | kulut |
| `ku_PalkkaPalkkio` | Palkat ja palkkiot | € | — | kulut |
| `ku_poisto2` | Poistot | € | — | kulut |
| `ku_rahOmaisLuovTappio` | Rahoitusomaisuuden luovutustappiot | € | — | kulut |
| `ku_Sakot` | Sakot ja muut rangaistukset | € | — | kulut |
| `ku_Satun` | Satunnaiset kulut | € | — | kulut |
| `ku_UlkopPalv` | Ulkopuoliset palvelut | € | — | kulut |
| `ku_ValittVero2` | Välittömät verot | € | — | kulut |
| `ku_VeroKoro` | Veronkorotukset | € | — | kulut |
| `LaskennPalkKorj` | Lakennallinen palkkakorjaus | € | — | johdetut_muuttujat |
| `LaskennPalkKorjPalautus` | Laskennallinen palkkakorjaus (palautus) | € | — | johdetut_muuttujat |
| `Liiketulos` | LIIKETULOS | € | — | johdetut_muuttujat |
| `Liikevaihto` | Liikevaihto / tuotot ammatista yhteensä | € | — | johdetut_muuttujat |
| `LiikevaihtoLahde` | Liikevaihtotiedon lähde | — | — | taustatiedot |
| `LiikeVoitTap` | Liikevoitto (tappio) | € | — | johdetut_muuttujat |
...
| `OmtyyppiVuosi` | Omistajatyyppi (vuositieto) | — | omistajatyyppi_1_1995_01_01 | taustatiedot |
| `op_EdTilikTulos` | Edellisten tilikausien tulos | € | — | oma_pääoma |
| `op_OsakePaaom` | Osakepääoma | € | — | oma_pääoma |
| `op_TilikTulos` | Tilikauden voitto tai tappio | € | — | oma_pääoma |
| `ops_OmaPaaomaYht` | Oma pääoma yhteensä | € | — | oma_pääoma |
| `PaaomanTuotto` | Pääoman tuotto | € | — | johdetut_muuttujat |
| `PalkansaajTehtTyotunti` | Palkansaajien tehdyt työtunnit | h | — | taustatiedot |
| `Palkkasumma` | Palkkasumma | € | — | taustatiedot |
| `PalksaajHtv` | Palkansaajat henkilötyövuosina | vv | — | taustatiedot |
| `PalksaajHtvLahde` | Palkansaajatiedon (htv) lähde | — | sntilahde_2_2012_01_01 | taustatiedot |
| `PalksaajKeskim` | Palkansaajat keskimäärin | lkm | — | taustatiedot |
| `PalksaajKeskimLahde` | Palkansaajatiedon (keskim.) lähde | — | sntilahde_2_2012_01_01 | taustatiedot |
| `PalksaajKKEstim` | Palkansaajat keskimäärin, kuukausiestimaatti (MAVA) | — | — | taustatiedot |
| `PalksaajVuosiEstim` | Palkansaajat keskimäärin, vuosiestimaatti (VILMTK) | — | — | taustatiedot |
| `PalkSummaEVR` | Palkkasumma (EVR) | € | — | taustatiedot |
| `PalkSummaMAVA` | Palkkasumma (MAVA) | € | — | taustatiedot |
| `PalkSummaVILMTK` | Palkkasumma (VILMTK) | € | — | taustatiedot |
| `PKSLuokitusEU` | EU;n pieni-, keskisuuri-, suuri-luokitus | — | — | taustatiedot |
| `PoikkeavatKokotiedot` | PoikkeavatKokotiedot | — | — | taustatiedot |
| `PoistArvonalentYht` | Poistot ja arvonalentumiset yhteensä | € | — | kulut |
| `PoistoEroMuutos` | Poistoeron muutos (lisäys -, vähennys +) | € | — | kulut |
| `PUOhitus` | PU:n ohitustieto | — | — | taustatiedot |
| `RahastYht` | Rahastot yhteensä | € | — | johdetut_muuttujat |
| `RahKulut` | Rahoituskulut | € | — | johdetut_muuttujat |
| `RahTuKuYht` | Rahoitustuotot ja -kulut yhteensä | € | — | johdetut_muuttujat |
| `RahTulos` | Rahoitustulos | € | — | johdetut_muuttujat |
| `RahTuotot` | Rahoitustuotot | € | — | johdetut_muuttujat |
| `sat_MaksKonsAvust` | Maksetut konserniavustukset | € | — | satunnaiset_erät |
| `sat_SaadKonsAvust` | Saadut konserniavustukset | € | — | satunnaiset_erät |
| `SatunEratYht` | Satunnaiset erät yhteensä | € | — | satunnaiset_erät |
| `SektoriluokkaVuosi` | Sektoriluokka (vuositieto) | — | sektoriluokitus_11_2013_01_01 | taustatiedot |
...
| `TilikausiLahde` | Tilikausitiedon lähde | — | — | taustatiedot |
| `TilikausiLopPvm` | Tilikauden loppu | — | — | taustatiedot |
| `TilikMuunnos` | Tilikauden arvot muunnettu 12 kk mittaiseksi | kk | — | taustatiedot |
| `TilikPituus` | Tilikauden pituus | kk | — | taustatiedot |
| `TilikTulos` | Tilikauden voitto (tappio) | € | — | johdetut_muuttujat |
| `tilinpKehikko` | Tilinpäätöskehikkoon kuuluminen | — | — | taustatiedot |
| `TilinpSiirrotYht` | Tilinpäätössiirrot yhteensä | € | — | johdetut_muuttujat |
| `ToimAikaTilikausi` | Toiminta-aika tilikaudella | kk | — | taustatiedot |
| `ToimAikaVuosi` | Toiminta-aika kalenterivuonna | kk | — | taustatiedot |
| `ToimipVuosiTila` | Toimipaikkatiedon vuositila | — | — | taustatiedot |
| `Tol2008Vuosi` | Toimiala (TOL 2008) | — | toimiala_1_2008_01_01 | taustatiedot |
| `tol2008VuosiPuhtPros5` | TOL 2008 puhtausprosentti (5 nro taso) | — | — | taustatiedot |
| `tu_ArvonalPysVastSij` | Arvonalentumiset pysyvien vastaavien sijoituksista | € | — | tuotot |
| `tu_AvustTuki` | Saadut avustukset ja tuet | € | — | tuotot |
| `tu_HkohtTulolTuotVeronalLuovVoit` | Henkilökohtaisen tulolähteen tuotot ja veronalainen luovutusvoitto | € | — | tuotot |
| `tu_KayttOmaisOsakLuovVoitto` | Ko osakkeitten luovutus- ja purkuvoitot | € | — | tuotot |
| `tu_KorkoKonsYri` | Korkotuotot saman konsernin yrityksiltä | € | — | tuotot |
| `tu_KorkoOmistYhtYri` | Korkotuotot omistusyhteysyrityksiltä | € | — | tuotot |
| `tu_LiiketoimMuutYht` | Liiketoiminnan muut tuotot yhteensä | € | — | tuotot |
| `tu_MaatalTulolah` | Maatalouden tulolähteen tuotot | € | — | tuotot |
| `tu_MuuKayttOmaisLuovVoitto` | Muut käyttöomaisuuden luovutusvoitot | € | — | tuotot |
| `tu_MuutKork` | Muut korkotuotot | € | — | tuotot |
| `tu_MuutLiikToimMuutTuot` | Muut liiketoiminnan muut tuotot | € | — | tuotot |
| `tu_MuutRah` | Muut rahoitustuotot | € | — | tuotot |
| `tu_PalArvonal` | Palautuvat arvonalennukset | € | — | tuotot |
| `tu_RahOmLuovVoitto` | Rahoitusomaisuuden luovutusvoitot | € | — | tuotot |
| `tu_SaadOsinko` | Saadut osingot | € | — | tuotot |
| `tu_Satun` | Satunnaiset tuotot | € | — | tuotot |
| `tu_TuloslaskMuuVerot` | Tuloslaskelman muut verottomat tuotot | € | — | tuotot |
| `tu_ValmOmaKaytto` | Valmistus omaan käyttöön | € | — | tuotot |
| `tu_VoitOsuYhtym` | Voitto-osuudet yhtymistä | € | — | tuotot |
| `Tulorahoitus` | Tulorahoitus | € | — | johdetut_muuttujat |
| `TulosEnnenSatErat` | Voitto (tappio) ennen satunnaisia eriä | € | — | johdetut_muuttujat |
| `TulosEnnenTilinpSiirrotVerot` | Voitto (tappio) ennen tilinpäätössiirtoja ja veroja | € | — | johdetut_muuttujat |
| `TuloverolaskTarkKulu` | Tuloverolaskelman tarkistus koodi (kulut) | — | — | laatumuuttujat |
| `TuloverolaskTarkTulo` | Tuloverolaskelman tarkistus koodi (tulot) | — | — | laatumuuttujat |
| `TuototMaatalous` | Tuotot maataloudesta | € | — | tuotot |
| `TuototMetsatalous` | Tuotot metsätaloudesta | € | — | tuotot |
| `ulkomaanTavaraKaupHarj` | Ulkomaantavarakaupan harjoittaminen | — | — | taustatiedot |
| `va_AineetonOik` | Aineettomat oikeudet | € | — | vastaavaa |
| `va_AineTarv` | Aineet ja tarvikkeet | € | — | vastaavaa |
| `va_EnnakkoMaks` | Ennakkomaksut | € | — | vastaavaa |
| `va_KayttOmaisArvopap` | Käyttöomaisuusarvopaperit | € | — | vastaavaa |
| `va_KayttOmaisSaam` | Muut käyttöomaisuussaamiset | € | — | vastaavaa |
| `va_KeskenerTuote` | Keskeneräiset tuotteet | € | — | vastaavaa |
| `va_Kiint` | Kiinteistöt | € | — | vastaavaa |
| `va_KoneKalusto` | Koneet ja kalusto | € | — | vastaavaa |
| `va_LainaSaam` | Lainasaamiset | € | — | vastaavaa |
| `va_MuuKayttOmais` | Muu käyttöomaisuus | € | — | vastaavaa |
| `va_MuuRahoitOmais` | Muu rahoitusomaisuus | € | — | vastaavaa |
| `va_MuuSaam` | Muut saamiset | € | — | vastaavaa |
| `va_MuuVaihtOmais` | Muu vaihto-omaisuus | € | — | vastaavaa |
| `va_Myyntisaam` | Myyntisaamiset | € | — | vastaavaa |
| `va_OsaTulSaam` | Osatuloutuksen saamiset | € | — | vastaavaa |
| `va_PankkiSaam` | Pankkisaamiset | € | — | vastaavaa |
| `va_PitkaVaikMeno` | Pitkävaikutteiset menot | € | — | vastaavaa |
| `va_Rahat` | Rahat | € | — | vastaavaa |
| `va_RahoitOmaisArvopap` | Rahoitusomaisuusarvopaperit | € | — | vastaavaa |
| `va_SaamKonsYri` | Käyttöomaisuussaamiset saman konsernin yrityksiltä | € | — | vastaavaa |
| `va_SaamOmistYhtYri` | Saamiset omistusyhteysyrityksiltä | € | — | vastaavaa |
| `va_SaamOmYhtYri` | Käyttöomaisuussaamiset omistusyhteysyrityksiltä | € | — | vastaavaa |
| `va_SaamSamaKonsYri` | Saamiset saman konsernin yrityksiltä | € | — | vastaavaa |
| `va_SiirtoSaam` | Siirtosaamiset | € | — | vastaavaa |
| `va_Tavara` | Tavarat | € | — | vastaavaa |
| `va_VaihtOmaisArvopap` | Vaihto-omaisuusarvopaperit | € | — | vastaavaa |
| `va_VaihtOmaisKiint` | Vaihto-omaisuuskiinteistöt | € | — | vastaavaa |
| `va_ValmTuote` | Valmiit tuotteet | € | — | vastaavaa |
| `VaihtOmaisYhtTilikAl` | Vaihto-omaisuus yhteensä tilikauden alussa | € | — | vastaavaa |
| `VaihtOmLaatukoodi` | Tilikauden alun vaihto-omaisuustietojen laatukoodi | — | — | laatumuuttujat |
| `ValmTuoteTilikAl` | Valmiit tuotteet tilikauden alussa | € | — | vastaavaa |
| `VapaaehtVaraukset` | Vapaaehtoiset varaukset | € | — | vastaavaa |
| `VapaaehtVarauksetMuutos` | Vapaaehtoisten varausten muutos | € | — | vastaavaa |
| `VarallLaskTarkKoodiOmaP` | Varallisuuslaskelman tarkistus koodi (oma pääoma) | — | — | laatumuuttujat |
| `VarallLaskTarkKoodiTulosTase` | Tilikauden tuloksen tarkistus koodi (tulos ja tase) | — | — | laatumuuttujat |
| `VarallLaskTarkKoodiVarat` | Varallisuuslaskelman tarkistus koodi (varat) | — | — | laatumuuttujat |
| `VarallLaskTarkKoodiVelat` | Varallisuuslaskelman tarkistus koodi (velat) | — | — | laatumuuttujat |
| `vas_KayttOmais` | Käyttöomaisuus yhteensä | € | — | vastaavaa_yhteensä |
| `vas_RahoitOmais` | Rahoitusomaisuus yhteensä | € | — | vastaavaa_yhteensä |
| `vas_VaihtOmais` | Vaihto-omaisuus yhteensä | € | — | vastaavaa_yhteensä |
| `vas_VaratYht` | Varat yhteensä | € | — | vastaavaa_yhteensä |
| `VastaavaYht` | Vastaavaa yhteensä | € | — | vastaavaa_yhteensä |
| `VastattavaYht` | Vastattavaa yhteensä | € | — | vastattavaa_yhteensä |
| `ve_JoukkoVelkakLaina` | Joukkovelkakirjalainat | € | — | vastattavaa |
| `ve_KonsYri` | Velat saman konsernin yrityksille | € | — | vastattavaa |
| `ve_LainatRahLait` | Lainat rahoituslaitoksilta | € | — | vastattavaa |
| `ve_Muu` | Muut velat | € | — | vastattavaa |
| `ve_OmistYhtYri` | Velat omistusyhteysyrityksille | € | — | vastattavaa |
| `ve_Osakas` | Velat osakkaille | € | — | vastattavaa |
| `ve_OstoVe` | Ostovelat | € | — | vastattavaa |
| `ve_PaaomLaina` | Pääomalainat | € | — | vastattavaa |
| `ve_Siirto` | Siirtovelat | € | — | vastattavaa |
| `ve_VaihtoVelkaKirjLain` | Vaihtovelkakirjalainat | € | — | vastattavaa |
| `verohoikmuoto` | Verohallinnon oikeudellinen muoto | — | verohoikmuot_2_2012_01_01 | taustatiedot |
| `VersioID` | Tilastoversio | — | — | taustatiedot |
| `ves_LyhytaikYhteens` | Lyhytaikaiset velat yhteensä | € | — | vastattavaa_yhteensä |
| `ves_PitkaaikYhteens` | Pitkäaikaiset velat yhteensä | € | — | vastattavaa_yhteensä |
| `ves_Yhteens` | Velat yhteensä | € | — | vastattavaa_yhteensä |
...
| `YrittajatKeskim` | Yrittäjät keskimäärin | henk. | — | taustatiedot |
| `yrittajatLahde` | Yrittäjätiedon (htv) lähde | — | sntilahde_2_2012_01_01 | taustatiedot |
| `oik` | Oikeudellinen muoto | — | oikeudell_muoto_1_1984_01_01 | — |
| `ku_sosturvamaks` | Sosiaaliturvamaksut yhteensä | — | — | — |
...
- kauppatavaroiden hankinta + kauppatavaroiden varastomuutos = BRUTTOARVO
...
- aine- ja tarvikeostot - ostot muilta toimipaikoilta + ostovarastojen muutos - ulkopuoliset palvelut - liiketoiminnan muut kulut = JALOSTUSARVO
...
ku_KorkoSamaKonsYri + ku_KorkoOmistusYhtYri + ku_MuutKorko
...
Konsernirekisterin perimmäisen omistajan maan perusteella määräytyy onko kyseessä kotimainen konserni vai ulkomaalainen. Tämän tiedon perusteella konsernirekisterin tiedoista saadaan konsernin kotimaisille yhtiöille päivitettyä omistajatyyppi. Osakkuus / yhteisyritykset yhteenlasketun äänivallan mukaan suurimman omistajan tyypin mukaan. Kunnan tai valtion konserniin kuuluvat määritetään konsernin tyypin perusteella. Ulkomaalaisomisteisille konsernien suomalaisille tytäryhtiöille päivitetään omistajatyypiksi 5 eli Ulkomaalaisomisteinen ja konsernisuhteen äänivallasta päivitetään yritykselle ulkomaan määräysvalta. Ulkomaalaisomisteisia ovat yritykset, joissa ulkomaalaisen omistuksen osuus on yli 50 prosenttia sekä ulkomaalaisten konsernien tytäryhtiöt.
Niille yksiköille, jotka eivät löydy konsernirekisteristä, omistajatyyppi päivitetään verohallinnon oikeudellisen muodon perusteella (verohoikmuoto).
...
***********
Palkansaajien lukumäärä keskimäärin kalenterivuoden aikana (nuppiluku, head count)

Kolme henkilöä, jotka tekevät töitä läpi vuoden puolet normaalityöajasta = 3. 
Kolme henkilöä, jotka työskentelevät neljä kuukautta vuodesta = 3 * (4/12) = 1. 

Palkansaajat keskimäärin ei ole yritykseltä palkkaa saaneiden henkilöiden lukumäärä.

Määritelmään odotettavissa täsmennys toiminta-aikaan liittyen (toiminta-aika kuukausina kalenterivuonna).
 
Lasketaan tyypittelemällä työntekijät työsuhteen luonteen mukaan; kokopäiväinen toimi, työpaikan vaihto … .
Määritetään yrityksen toiminta-aika kuukausitiedoista.

Henkilötasolla vaikutus keskim. lukumäärään on joko;
1 jatkuvassa työsuhteessa, läpi vuoden toimivissa yrityksissä työskenteleville, tai
työstä saadun palkan osuus kaikista palkoista kerrottuna HTV - estimaatissa lasketusta kokonaistyöpanoksesta.

Yhden henkilön yhteenlaskettu kontribuutio palkansaajien keskimääräisen lukumäärän summaan voi olla > 1.
...
Luokittelu perustuu EU:n suositukseen. (Vuoteen 2002 asti 1996/280/EY, vuodesta 2003 lähtien 2003/361/EY). 
Mahdolliset arvot ovat: Mikro, Pieni, Keskisuuri, Suuri, Ei määritelty.
...
1      Alustavasti pisteytetty. Evr-tiedot saapuneet ja pisteytetty, tiedot käsitelty automaattisesti evr-aineistoa editoimalla tai jos se on todettu virheelliseksi, niin tiedot on imputoitu.
2       Pisteytetty. Tuloslaskelma-ja tasetiedot hyväksytty, mutta liikevaihdon ja kulujen erittelyt (tilkes-tiedot) imputoitu, tilkes saapunut, käytössä vain tilkes-otokseen kuuluville.
3       Keskeneräinen                                                        
4       Alustavasti hyväksytty. Tuloslaskelma-ja tasetiedot hyväksytty, mutta liikevaihdon ja kulujen erittelyt imputoitu, tilkes ei ole saapunut, käytössä vain tilkes-otokseen kuuluville. 
5       Pakkohyväksytty. Sama kuin lopullisesti hyväksytty.
6       Massakorjattu. Ei käytössä yrityksen vuositiedoille.
7       Lopullisesti hyväksytty. Jos kuuluu otokseen, kaikki tiedot on hyväksytty; jos ei kuulu otokseen, tuloslask.- ja tasetiedot hyväksytty ja erittelyt (tilkes-tiedot) imputoitu.
8       Massahyväksytty. Kaikki tiedot (tuloslask., tase ja tilkes) hyväksytty automaattisesti.
9       Kopioitu edellisvuodelta. Ei käytössä yrityksen vuositiedoille.
Hyväksytty tarkoittaa, että tiedot on manuaalisesti käsitelty paitsi jos erikseen mainitaan, että on kyse automaattisesta hyväksynnästä.
...
1 = Tuoja (harjoittaa tuontia)
2 = Viejä (harjoittaa vientiä)
3 = Molempia (harjoittaa tuontia ja vientiä)
Määritelmän mukaan ulkomaankauppaa harjoittaa yritys, jonka tuonnin/viennin kynnysarvo on 12 000 euroa ja kauppatapahtumia on vähintään kahtena kuukautena vuodessa tai kaupan arvo yli 120 000 euroa (tällöin riittää yksi kauppatapahtuma ko. vuonna). Tiedot saadaan tullista.
...
1.       Ei ulkomaisia yksiköitä, ei asunto-osakeyhtiöitä, ei konkurssipesiä: verohOikMuoto ei ole '13', '54', '70'
2.       Ei julkisyhteisöjä yleiseen vuositilastoon (liikelaitoksista (16) otetaan mukaan hyväksytyt)
3.       Toimialarajaus: Ei valita julkista hallintoa, maanpuolustusta tai pakollista sosiaalitointa: tol2008Vuosi ei ole 84*, 97
4.       Oikeudellinen yksikkö täyttää jonkin seuraavista ehdoista:
a.       sektoriluokkaVuosi = 11102, 11103, 121, 12211, 12212, 12213, 12221, 12222, 12223, 12231, 12232, 12233, 12801, 12802, 12803, 12601, 12602, 12603, 123, 12501, 12502, 12503, 1242, 13141, 11211, 11212, 11213, 11221, 11222, 11223, 141, 12701, 12702, 12703, 129 TAI
b.       (sektoriluokkaVuosi = 11101 JA omtyyppi = 2) TAI
c.       (sektoriluokkaVuosi = 11101 JA omtyyppi =  3, 4 JA  verohOikMuoto ≠ 40,41,42,43,60,61,62,63) TAI
d.       sektoriluokkaVuosi is null.
...
Määritelmä: Työpanos, josta ei makseta palkkaa. Yrittäjiä enintään 2 htv:ta ja 4 keskimäärin per yritys.
  
Estimointi perustuu eri aineistojen yhdistämiseen Eläketurvakeskuksen YEL / MYEL -aineistoon. 
Aineistoja:
- VILMTK (vuosi-ilmoitustietokanta, henkilöittäin ja työsuhteittain kalenterivuoden aikana, verohallinto)
- YTY:n oikeudelliset yksiköt
- yhtiömiesaineisto (verohallinto)
- osakasaineisto (verohallinto)
- yrittäjäperheenjäsenet (väestötilastot)
 
Yrittäjien laskenta
*********************
Potentiaalisten yrittäjien lukumäärän laskenta yritystunnuksittain menetelmällisesti.
Saadaan yhdistämällä henkilöaineistot yrityksiin.

Lasketaan teoreettinen yrittäjätyöpanoksen maksimi potentiaalisten yrittäjien HTV - estimaattien avulla.
Lasketaan ”tilastollinen” yrittäjätyöpanos keskimääräisen työntekijäkohtaisen liikevaihdon avulla.
Yrittäjätyöpanos on pienempi kahdesta edellisestä.

Yrityksille, joihin ei yhdisty yrittäjiä, estimointi tehdään toimialan liikevaihto - palkansaaja -suhteen avulla.
...
Tieto on vain tietyille toimialan K yrityksille. Muodostuu muuttujista ku_elake+ku_muuhenksivu.

#### `HyodPalvTot` — Hyödykkeiden ja palveluiden ostot yhteensä

Tieto on vain tietyille toimialan K yrityksille. Koostuu muuttujista ku_OstotYht+ku_UlkopPalv+ku_LiiketoimMuutYht

#### `EBSTilastoyksikko` — EBSTilastoyksikko

Yritysten rakenne- ja tilinpäätöstilaston, alueellisen yritystoimintatilaston sekä ulkomaiset tytäryhtiöt Suomessa -tilaston tilastoyksikkö vuodesta 2021 lähtien. Tämä muuttuja korvasi tilastossa muuttujan Vuositilastonyksikkö. EBS-asetuksen aktiivisen markkinaehtoisen yrityksen mukainen määritelmä. Yritykset on valittu tilastoon mikäli ne toimivat markkinaehtoisesti sekä niillä on liikevaihtoa, liiketoiminnan muita tuottoja, tasetta, henkilöstöä tai investointeja tilastovuonna.
