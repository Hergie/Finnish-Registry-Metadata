# KEHA_Työnhaku: KEHA-keskuksen työnvälitystilaston aineisto

- **Identifier:** `TEM_19912023_jua_tyonhaku_001.xml`
- **DOI:** `work_2016-10_2016-10-16_ain_0002`
- **Temporal coverage:** 1991-01-01 - 2024-12-31
- **Published:** 2025-04-15
- **Organisation:** Työ- ja elinkeinoministeriö
- **Variable count:** 96
- **Observation count:** 7,757,662
...
"Työnhaku"-aineisto sisältää seuraavat työnvälitystilaston aineistot:

YTYOLL: Henkilön työllisyystiedot
YTHAKU: Henkilön työnhakutiedot
YSIJOIT: Henkilön toimenpidesijoitukset
YTKOKE: Työkokeilu työpaikalla
YTYOKOU: Henkilön työvoimakoulutustiedot
YHTKAMM: Henkilön työvoimakoulutuksen tavoiteammatti
YTVALIT: Henkilön työnvälitykset
YTVPOLL: Henkilön työvoimapoliittiset lausunnot
YLIIKK: Liikkuvuusavustukset
YTHAKSU: Henkilön työnhaku- ym. suunnitelmat 
KTYOKOU: Työvoimakoulutuksen kurssin tiedot

URA-tietojärjestelmä koostuu kolmesta rekisteristä: henkilöasiakasrekisteristä, työnantajarekisteristä sekä työvoimakoulutuksen järjestäjärekisteristä. URA-järjestelmän käyttöön siirryttiin työvoimatoimistoissa vuonna 1998. Tätä ennen vuodesta 1990 lähtien käytössä oli TYÖTIE-tietojärjestelmä.Työhallinnon henkilöasiakasrekisteristä tilastoitavat tiedot siirretään kuukausittain työnvälitystilastojärjestelmän yksilötietokantoihin. Tämä työhallinnon tilastojärjestelmään siirretty tietosisältö on saatavilla sähköisessä muodossa vuodesta 1991 alkaen. Vuosien 1990 ja 1991 vaihteessa tilastojärjestelmään siirrettiin kaikki tiedot tällöin aktiivisina olleista työnhakijoista. Näiden osalta tilastojärjestelmä sisältää asiakkuustietoja myös 1980-luvulta.
 
Tiedot ovat URAssa ja tilastojärjestelmässä pääasiassa jaksoittain siten, että mahdolliset uudet tiedot esimerkiksi asiakkaan työllisyys- ja työttömyysjaksoista sekä asiakkaaseen kohdistetuista työvoimapoliittisista toimenpiteistä lisätään jo olemassa olevien tietojen rinnalle. Luokituksista työnhakijan asiointikieli ja kansalaisuus kirjataan järjestelmään kuitenkin niin, että esimerkiksi asiakkaan kansalaisuuden muuttuessa uusi koodi ei kirjaudu vanhan rinnalle vaan korvaa sen, jolloin vanhentunut tieto poistuu rekisteristä. Tilastokeskuksen valmisaineistoon uusimman tiedon lisäksi kirjataan kuitenkin henkilön vanhentuneetkin perustiedot päivityspäivämäärän kanssa.

Vuosien kuluessa työhallinnon henkilöasiakasrekisteri on laajentunut. Pääsääntöisesti muutokset rekisterin sisällössä on toteutettu uusia koodeja lisäämällä, jolloin on vältytty päällekkäisyyksiltä yksittäisten koodien merkityksissä eri aikoina. Lisäksi luokitusten muuttuessa tilastojärjestelmään on pyritty tekemään konversioita siten, että uudet ja vanhat tiedot olisivat mahdollisimman hyvin vertailukelpoisia. Yksittäisten koodien muuttuessa myös vanhentuneet koodit säilytetään tavallisesti järjestelmässä. Näin määrättyä asiaa koskeva tieto kirjautuu järjestelmään, vaikka se olisi TE-toimistossa tallennettu virheellisesti vanhaa koodia käyttäen.
Asiakasrekisterin tiedot kerätään työ- ja elinkeinotoimistoissa pääasiassa henkilöasiakkaalta itseltään hänen antamiinsa selvityksiin ja dokumentteihin perustuen. Lisäksi tietoa saadaan seuraavista lähteistä:
-	Työnantajien antamat tiedot työhön osoitusten tuloksista, ryhmälomautuksista sekä muutosturvan piiriin kuuluvista henkilöistä
-	Työvoimakoulutuksen järjestäjien tiedot työvoimakoulutuksesta
-	Kansaneläkelaitos ja työttömyyskassat (työttömyysturvalain ja julkisesta työvoimapalvelusta annetun lain mukaiset tiedot ko. lakien mukaisten etuuksien määräämistä varten)
-	Työvoimapalvelukeskuksen loppuraportti työnhakijan palveluprosessista
...
HUOM! TE-toimistoissa saatetaan korjata joidenkin hakijoiden tietoja jälkikäteen, jolloin yksittäisiä jaksoja saatetaan poistaa. Tutkijapalveluiden aineistossa on kuitenkin toistaiseksi mukana kaikki havaintovuoden lopussa rekisterissä olevat jaksot. 


Vuoden 2023 aineistossa on päivittyneitä koodistoja:
- A-TMT lausuntokoodisto 2023: uusi koodisto 03/2023 käyttöönotetuille A-TMT lausunnoille
- Kurssin laji 2023: lisätty yksi uusi koodi.  --- 16 Muutosturvakoulutus
- Työllistämisen laji 2023: lisätty yksi – uudelleen käyttöön eri selitteellä otettu – koodi.   --  55 TYÖLLISTÄMISTUKI uusi (1/23 alk.)
- Sektori 2023: lisätty yksi uusi sektorikoodi  -- 7 = Hyvinvointialue
- Erityisryhmä 2023: lisätty yksi uusi koodi. -- 09 Muutosturva 55+ uusi (1/2023 alk.)
- Sijoituksen rahalaji 2023: lisätty yksi uusi koodi.  -- 5 hakemus 55 vuotta täyttäneiden työll.tuesta
- Sijoituksen kohderyhmä 2023: lisätty yksi uusi koodi.
...
| `alkpv1` | Työnhaun alkamispäivä | — | — | YTHAKU |
| `esppv` | Edellisen työsuhteen päättymispäivä | — | — | YTHAKU |
| `hamaa` | Välitysmaa | — | — | YTHAKU |
| `hapkd` | Työnhaun päättymissyy | — | — | YTHAKU |
| `hedkd` | Työnhakua edeltävä toiminta | — | — | YTHAKU |
| `loppv1` | Työnhaun päättymispvm | — | — | YTHAKU |
| `otlupa` | Oleskelu/työlupa | — | — | YTHAKU |
| `toanoh` | Edellisen työnantajan toimiala-2 | — | — | YTHAKU |
| `tpskd` | Edellisen työsuhteen päättymissyy | — | — | YTHAKU |
| `ulkkd` | Hakija ulkomailta | — | — | YTHAKU |
| `tappvh` | Alkamispvm | — | — | YTYOLL |
| `tppvm` | Päättymispvm | — | — | YTYOLL |
| `tymsyy` | Työllisyyden muutossyy | — | — | YTYOLL |
| `tyok1` | Työllisyyskoodi | — | — | YTYOLL |
| `alkpv2` | Alkamispvm | — | — | YSIJOIT |
| `ammnos` | Työllistämisen ammatti | — | — | YSIJOIT |
| `eupnos` | ESR-projektikoodi | — | — | YSIJOIT |
| `kryhm` | Kohderyhmä | — | — | YSIJOIT |
| `loppv2` | Päättymispäivä | — | — | YSIJOIT |
| `ralaj` | Rahalaji | — | — | YSIJOIT |
| `saikd` | Työaika | — | — | YSIJOIT |
| `shlokd` | Henkilöstön kokoluokka | — | — | YSIJOIT |
| `sijkds` | Työllistämisen laji | — | — | YSIJOIT |
| `sipkd` | Työllistämisen päättymissyy | — | — | YSIJOIT |
| `staskd` | Sektori | — | — | YSIJOIT |
| `toanos` | Työllistäjän toimiala 2 (starttirahoista puuttuu) | — | — | YSIJOIT |
| `kotsk` | Suunnitelman laji | — | — | YTHAKSU |
| `thspv` | Suunnitelman tekopäivä | — | — | YTHAKSU |
| `alkpv7` | Jakson alk.pv | — | — | YTVPOLL |
| `kasnol` | Työttömyyskassan numero | — | — | YTVPOLL |
| `kelnol` | KELAn toimiston numero | — | — | YTVPOLL |
| `lausno` | Lausuntokoodi | — | — | YTVPOLL |
| `loppv7` | Jakson päättymispäivä | — | — | YTVPOLL |
| `rekpv` | Lausunnon antopäivä | — | — | YTVPOLL |
| `alkpv8` | Työsuhteen alkamispäivä | — | — | YTVALIT |
| `ammno3` | Välitysammatti | — | — | YTVALIT |
| `ilmno` | Työpaikkailmoitusnumero | — | — | YTVALIT |
| `loppv8` | Työsuhteen päätt.päivä | — | — | YTVALIT |
| `piikdv` | Välitys te-keskus | — | — | YTVALIT |
| `valkd` | Työhönvälitysalue | — | — | YTVALIT |
| `valpv` | Välityspäivä | — | — | YTVALIT |
| `vjskd` | Tukityöpaikka | — | — | YTVALIT |
| `alkpv4` | Työkokeilun alkamispäivä | — | — | YTKOKE |
| `eupnoko` | ESR-projektikoodi | — | — | YTKOKE |
| `kokai` | Kokeilun kesto (työpäivinä) | — | — | YTKOKE |
| `kokku` | Kokeilun kustantaja | — | — | YTKOKE |
| `loppv4` | Työkokeilun loppupvm | — | — | YTKOKE |
| `ammno` | Kokeilun ammatti | — | — | YTKOKE |
| `kokeilu` | Työkokeilun laji | — | — | YTKOKE |
| `kotav` | Kokeilun tavoite | — | — | YTKOKE |
| `taskd` | Kokeilun sektori | — | — | YTKOKE |
| `alkood` | Aloittamiskoodi | — | — | YTYOKOU |
| `alpvm` | Koulutuksen alkamispäivä | — | — | YTYOKOU |
| `ammnoj` | Sijoittumisammatti | — | — | YTYOKOU |
| `hapvm` | Koulutukseen hakupäivä | — | — | YTYOKOU |
| `hedkdk` | Koulutusta edeltävä toiminta | — | — | YTYOKOU |
| `klaji` | Koulutuslaji | — | — | YTYOKOU |
| `kopvt` | Koulutuspäivien lukumäärä | — | — | YTYOKOU |
| `ktunoh` | Kurssin tunnistenumero | — | — | YTYOKOU |
| `kunnos` | Sijoittumiskunta | — | — | YTYOKOU |
| `laatu` | Työsuhteen laatu | — | — | YTYOKOU |
| `papvm` | Koulutuksen päättymispäivä | — | — | YTYOKOU |
| `pasyy` | Päättymissyy | — | — | YTYOKOU |
| `styp` | Sijoittumistyyppi | — | — | YTYOKOU |
| `tyokd` | Työllisyyskoodi | — | — | YTYOKOU |
| `tyol` | Työllisyys | — | — | YTYOKOU |
| `valpt` | Valintapäätös | — | — | YTYOKOU |
| `vapmu` | Vapaamuuttuja (nykyisin tyhjää) | — | — | YTYOKOU |
| `ely` | Kouluttavan ELY-keskuksen koodi | — | — | KTYOKOU |
| `erryhm` | Erityisryhmä | — | — | KTYOKOU |
| `eupno` | ESR-projektikoodi | — | — | KTYOKOU, YTYOKOU |
| `kalkpv` | Kurssin alkamispäivä | — | — | KTYOKOU |
| `koukd` | KKOULUTUS | — | — | KTYOKOU |
| `ktuno` | Kurssin tunnistenumero | — | — | KTYOKOU |
| `ktyyp` | Koulutustyyppi | — | — | KTYOKOU |
| `kunno` | Koulutuskunta | — | — | KTYOKOU |
| `kurslaji` | Kurssilaji | — | — | KTYOKOU |
| `opkiel` | Pääopetuskieli | — | — | KTYOKOU |
| `perutk` | Kurssi perutettu | — | — | KTYOKOU |
| `ryhma` | Ryhmäkurssi | — | — | KTYOKOU |
| `tamtar` | Amm.tarkenne | — | — | KTYOKOU |
| `ammnol` | Henkilön aikaisemmat tavoiteammatit | — | — | YHTKAMM |
| `muupv2` | Muutospäivä | — | — | YHTKAMM |
| `avukd` | avustuslaji | — | — | YLIIKK |
| `piikdl` | kohdete-keskus | — | — | YLIIKK |
| `tappv1` | avustuspvm | — | — | YLIIKK |
| `etuus` | Etuuslaji | — | — | ysijoit |
| `oppisop` | Oppisopimus | — | — | ysijoit |
| `tukipros` | Suhteellinen osuus, jolla tukea maksetaan | — | — | ysijoit |
| `vos` | Valtionosuusrahoitteinen koulutus (v.2018 alkaen) | — | — | ktyokou |
...
zz= Ei käytössä,
00= Suomalainen syntyperä (30.4.2004 asti),
01= Inkeriläinen syntyperä (1.5.99 asti),
02= Suomalainen puoliso/sukulainen (1.5.99 asti),
03= Perheenjäsenet (30.4.2004 asti),
04= Pakolainen (30.4.2004 asti),
05= Työvoimapoliittinen siirtolainen (30.4.2004 asti),
06= Jatkuva oleskelulupa,
07= Pysyvä oleskelulupa (sis. P-EY),
08= ETA/EU-maan kansalainen+Sveitsi,
09= Muu palveluihin oikeutettu (30.4.2004 asti),
1A= Brexit pysyvä olesk.oikeus (PSEU),
1B= Brexit oleskeluoikeus (SEU),
1C= Tilapäinen oleskelulupa (ukrainalainen),
10= Tilap. ol.lupa (B),
11= Pysyvä ol.lupa (P)
...
HUOM! Julkinen työvoima- ja yrityspalvelu -lain muutoksen myötä vuoden 2013 alussa työharjoittelut siirtyivät YSIJOIT-taulusta YTKOKE-tauluun työkokeiluksi sitä mukaa, kun entiset työharjoittelujaksot päättyivät. Työkokeilut korvasivat ennen YSIJOIT-taulussa olleet työllistämisen lajit (SIJKDS) 70 (=työharjoittelu työmarkkinatuella) ja 71 (=työelämävalmennus työttömyysetuudella). Koodi 71 tuli voimaan vuonna 2010. Tilastoissa uuden koodin voimaantulo aiheutti siirtymää vuosien 2010-2012 aikana koodin 70 käytöstä koodille 71.
...
HUOM! Julkinen työvoima- ja yrityspalvelu -lain muutoksen myötä vuoden 2013 alussa työharjoittelut siirtyivät YSIJOIT-taulusta YTKOKE-tauluun työkokeiluksi sitä mukaa, kun entiset työharjoittelujaksot päättyivät. Työkokeilut korvasivat ennen YSIJOIT-taulussa olleet työllistämisen lajit (SIJKDS) 70 (=työharjoittelu työmarkkinatuella) ja 71 (=työelämävalmennus työttömyysetuudella).
...
C00B MUUTOSTURVARAHAN EDELLYTYKSET EIVÄT TÄYTY
C00D SUUNNITELMAAN SISÄLTYVÄ MUUTOSTURVAKOULUTUS
F001 TYÖSUHDE VOIMASSA,SAANUT ENIMMÄISAJAN SPÄIVÄRAHAA,TYÖKYVYTN
F002 HAKIJA ILMOITT.LÄHTEVÄNSÄ TYÖNHAKUUN EU/ETA-MAAHAN TAI SVEIT
F003 EI HAE TYÖT.ETUUTTA,  TYÖVOIMAPOLIITT. EDELLYTYKSIÄ EI SELVITETÄ
F010 ON ALOITTANUT TYÖN TUELLA
F011 ON OLLUT TYÖSSÄ, JOSTA TYÖNANTAJALLE ON MAKSETTU N. % TUKEA
F099 TIEDOTE
KK01 KOUL.KOKEILU OPPILAIT., EI ESTETTÄ TYÖTT.ETUUD. MAKSAMISELLE
KT01 KUNTOUTT.TYÖTOIMINNASSA, EI ESTETTÄ TYÖTT.ETUUD.MAKSAMISELLE
M000 TYÖTTÖMYYSETUUDEN MAKSAMISELLE EI TYÖVOIMAPOLIITTISTA ESTETTÄ
M012 KARENSSIHARKINTA LYKÄTTY TYÖN PÄÄTTYMISEN RIITAUTUKSEN TAKIA
OM01 ALOITTANUT OMAEHT. OPISKELUN, TYÖTT.ETUUD.MAKSAM. EI ESTETTÄ
OM03 EI OLE OIKEUTTA TYÖT.ETUUT. OMAEHT. OPISK. PERUSTEELLA, LAUSUNTO TOIMITETAAN MYÖH.
OM04 EI OLE OIKEUTTA TYÖT.ETUUT. OMAEHT. OPISK. PERUSTEELLA, SAAMISEN EDELLYT. EIVÄT TÄYTY
OM05 OMAEHT.OPISK.TYÖTT.ETUUD.KESKEYT.TILAP., LAUSUNTO TOIM.MYÖH.
OM09 OMAEHTOISET OPINNOT PÄÄTTYNEET, LAUSUNTO TOIMITETAAN MYÖHEMMIN
P010 KARENSSI 45 PÄIVÄÄ, EROSI TAI EROTETTIIN TYÖSTÄ
P013 KARENSSI 45 PÄIVÄÄ, VIRASTA PIDÄTTÄMINEN
P020 KARENSSI 45 PÄIVÄÄ, KIELTÄYTYI VARMASTA TYÖSTÄ
P021 KARENSSI 30 PÄIVÄÄ, KIELTÄYTYI VARMASTA ENINT. 2 VKOA KESTÄVÄSTÄ TYÖSTÄ
P030 KARENSSI 7 PÄIVÄÄ, TYÖNHAKUUN TAI PALVELUIHIN LIITTYVÄ MENETTELY
P031 KARENSSI 14 PÄIVÄÄ, TYÖNHAKUUN TAI PALVELUIHIN LIITTYVÄ MENETTELY
P070 TYÖSSÄOLOVELVOITE, EI ETUUSOIKEUT. TOIST., TYÖNHAKUUN TAI PALV. LIIT. MENETTELY
S010 1.5.2022 asti: KARENSSI 90 PÄIVÄÄ, EROSI TYÖSTÄ
S011 1.5.2022 asti: KARENSSI 30 PÄIVÄÄ, EROSI ENINT. 5 PÄIVÄÄ KESTÄVÄSTÄ TYÖSTÄ
S012 1.5.2022 asti: KARENSSI 60 PÄIVÄÄ, AIHEUTTI ITSE TYÖN PÄÄTTYMISEN
S013 1.5.2022 asti: KARENSSI 60 PÄIVÄÄ, VIRASTA PIDÄTTÄMINEN
S014 1.5.2022 asti: KARENSSI 30 PÄIVÄÄ, VIRASTA PIDÄTTÄMINEN
S020 1.5.2022 asti: KARENSSI 90 PÄIVÄÄ, KIELTÄYTYI VARMASTA TYÖPAIKASTA
S022 1.5.2022 asti: KARENSSI 60 PÄIVÄÄ, KIELTÄYTYI YLI 2 VIIKKOA KESTÄVÄSTÄ TYÖSTÄ
S023 1.5.2022 asti: KARENSSI 30 PÄIVÄÄ, KIELTÄYTYI ENINT. 2 VIIKON TYÖSTÄ
S030 1.5.2022 asti: KARENSSI 60 PÄIVÄÄ, KIELTÄYTYI PALVELUSTA
S031 1.5.2022 asti: KARENSSI 60 PÄIVÄÄ, KESKEYTTI PALVELUN
S040 KOULUTUSTA VAILLA OLEVA NUORI, EI HAKENUT OPISKELUPAIKKAA
S041 KOULUTUSTA VAILLA OLEVA NUORI, KESKEYTTI OPINNOT
S042 KOULUTUSTA VAILLA OLEVA NUORI, EI NOUDATTANUT SUUNNITELMAA
S050 1.5.2022 asti: KARENSSI VÄHINT. 15 PV, EI TULLUT SUUNNITELMAN LAATIMISEEN
S051 1.5.2022 asti: KARENSSI VÄHINT. 30 PV, KIELTÄYTYI SUUNNITELMAN LAATIMISESTA
S052 1.5.2022 asti: KARENSSI 60 PÄIVÄÄ, LAIMINLÖI TOTEUTTAA SUUNNITELMAA
S060 PÄÄTOIMINEN OPISKELIJA, EI OIKEUTTA TYÖTTÖMYYSETUUTEEN
S061 EI ETUUSOIKEUTTA PALKATTOMAN TYÖN TAKIA
TK01 ON TYÖVOIMAKOULUTUKSESSA, EI ESTETTÄ TYÖTT.ETUUD. MAKSAMISEL
TM01 HAKIJA 17-V. AMM.KOULUT.VAILLA EI OLE OIKEUTTA TYÖM.TUKEEN
TM02 EI OIKEUTTA TMTUKEEN, OIKEUS ANSIOTYÖHÖN TILAP. OLESK.LUVALLA
TP00 TYÖLLISTYMISTÄ EDISTÄVÄ PALVELU ON PÄÄTTYNYT, LAUSUNTO TOIMITETAAN MYÖHEMMIN
TV01 TYÖNHAKUVALMENNUKSESSA, EI ESTETTÄ TYÖTT.ETUUD. MAKSAMISELLE
TY01 TYÖKOKEILUSSA TYÖPAIKALLA, EI ESTETTÄ TYÖT.ETUU.MAKSAMISELLE
T001 TYÖTTÖMYYSETUUDEN MAKSAMISELLE EI TYÖVOIMAPOLIITTISTA ESTETTÄ
T002 EI OIKEUTTA TYÖTTÖM.ETUUTEEN, EI HAE KOKOAIKATYÖTÄ
T003 EI OIKEUTTA TYÖTTÖM.ETUUTEEN, EI OLE TYÖTÖN
T004 EI OIKEUTTA TYÖTTÖM.ETUUTEEN, TYÖNHAKU EI OLE VOIMASSA
T007 ALOITT.ENINT. 6 KK KEST LYHYTKEST.OPINNOT, TYÖTT.ETUUD.MAKSAM. EI ESTETTÄ
T008 ALOITT.ENINT. 3 KK KEST LYHYTKEST.OPINNOT, TYÖTT.ETUUD.MAKSAM. EI ESTETTÄ
T009 TYÖSSÄOLOVELVOITTEEN VOIMASSAOLO (ETUUSOIKEUDEN MENETYS) JATKUU
T010 KOUL. VAIL. OLEVA NUORI, EI ETUUSOIKEUT. TOIST., KOULUT. LIIT. LAIMINLYÖNTI/ MENETTELY
T011 PÄÄTOIMINEN OPISKELIJA, EI OIKEUTTA TYÖTTÖMYYSETUUTEEN
T100 EI OIKEUTTA TYÖTTÖM.ETUUTEEN, TYÖNHAKU EI OLE VOIMASSA
UV01 URAVALMENNUKSESSA, EI ESTETTÄ TYÖTTÖMYYSETUUDEN MAKSAMISELLE
V001 VUOROTTELUVAPAANKORVAUK. MAKS. EI OLE TYÖV.POLIITT. ESTETTÄ
V002 EI OIKEUTTA VUOROTTELUVAPAAKORVAUKSEEN
V070 1.5.2022 asti: TYÖSSÄOLOVELVOITE, KAKSI LAIMINLYÖNTIÄ TAI VAST. 6 KK AIKANA
Y001 HAKIJAN YRITYSTOIMINTA ALKANUT, EI ESTETTÄ TYÖTT.EDUN MAKS.
Y002 TYÖT.ET. MAKS. EI ESTET, HAKIJAN OMASSA TYÖSSÄ TYÖLL. ALKAN.
Y003 YRITYST.SATUNN TAI OMA TYÖ SIVUTOIM, EI ESTET.TYÖT.EDUN MAKS.
Y004 PERH.JÄSENEN TYÖSK. YRITYKS. PÄÄTT, EI ESTET.TYÖT.EDUN MAKS.
Y005 TYÖLLISTYY PÄÄTOIM. YRITTÄJÄNÄ, EI OIKEUTTA TYÖTT.ETUUTEEN
Y006 TYÖLLISTYY PÄÄTOIM. OMASSA TYÖSSÄÄN, EI OIKEUTTA TYÖTT.ETUU.
Y007 TYÖTT.ET. MAKSAM. EI TYÖV.POL. EST, SIVUTOIM.YRITT. LASK.PALV
Y008 EI OIKEUTTA TYÖTT.ET., PÄÄTOIM. YRITTÄJÄ LASK.PALV.YRITYKSEN
Y009 TYÖTT.ET.MAKS. EI ESTETTÄ, TYÖ YRITT.LASK.PALV.YRIT. ON PÄÄTT
Z001 TE-TOIMISTON SISÄINEN TIEDOTE ,EI TOIMITETA ETUUD.MAKSAJALLE
Z004 TYÖSSÄOLOVELVOITE TÄYTTYNYT, TIEDOTE
Z005 KOULUTUSTA VAILLA OLEVA NUORI, ETUUSOIKEUDEN PALAUTUMINEN
